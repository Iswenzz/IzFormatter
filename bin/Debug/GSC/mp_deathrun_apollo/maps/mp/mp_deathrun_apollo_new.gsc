...
//AUTO  ambientPlay("mapsong");
 ...
 thread activator9();
 thread activator10();
//AUTO  thread jumproompod1();
//AUTO  thread jumproompod2();
 thread trap0();
 thread trap1();
 thread trap2();
 thread trap3();
...
//AUTO  thread secretroom();
 ...
 thread pad23();
 thread pad24();
//AUTO  thread specialroom();
//AUTO  thread specialroom2();
//AUTO  thread specialroom3();
//AUTO  thread specialroom4();
//AUTO  thread specialroom5();
//AUTO  thread specialroom6();
//AUTO  thread specialroom7();
 thread creator();
...
//AUTO iPrintlnBold("^5opening ^3the ^5door^3...^5!!!");

wait(7);

//AUTO iPrintlnBold("^5The ^3doors ^5is ^3open ^5!!!");
...
//AUTO iPrintLn("^4Map made by ^5Mr.Xx^7(mapper) & ^5MadLion ^7(scripter)");

wait(60);


//AUTO iPrintLn("^4xfire: ^5dragec1997 ^7& ^5madlion3");
...
//AUTO iPrintlnBold("^1OMG ^5you ^7found ^5my ^7secret^5!!");
