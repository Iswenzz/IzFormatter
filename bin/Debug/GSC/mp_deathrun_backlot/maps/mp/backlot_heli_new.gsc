...
//AUTO     level.activ iprintlnbold( "Flyable Chopper!" );
//AUTO     level.activ iprintlnbold( "Press MELEE to move forward and FIRE to fire" );
//AUTO     level.activ iprintlnbold( "rockets." );
    wait( 2 );
...
heli_vertical( dir )
{
    if( dir == "up" )
    {
        ...
        {
//AUTO             self iprintlnbold("WTF? Crash the multi-million dollar chopper?!");
//AUTO             self iprintlnbold("Jesus Christ, you suck at this stuff man.");
