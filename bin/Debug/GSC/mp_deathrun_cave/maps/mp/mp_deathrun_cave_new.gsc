...
//AUTO iprintln( "^1>>^1Playing: ^9Make it Bun Dem - Skrillex & Damian Marley");
object1 moveY(50, 3);
object2 moveY(-50, 3);
wait(4);
}
...
trigger delete();
{
//AUTO iprintlnbold(" ^3" + player.name + " Escaped Cave at ^3 1st Place");
wait(0.1);
object1 moveY(-67, 1);
object2 moveY(67, 1);
wait(0.1);
...
//AUTO 		iprintln("^1Playng:^7 Olly Murs feat. Flo Rida - Troublemaker");
...
//AUTO 		iprintln("^1Playng:^7 Macklemore & Ryan Lewis - Can't Hold Us Dubstep");
		player freezeControls(true);
		level.activ freezeControls(true);
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
...
//AUTO         player GiveWeapon( "m1014_mp" );
        ...
        level.activ setOrigin( acti.origin );
//AUTO         level.activ TakeAllWeapons();
//AUTO         level.activ GiveWeapon( "m1014_mp" );     
        wait 0.05;
//AUTO         player switchToWeapon( "m1014_mp" );
//AUTO         level.activ SwitchToWeapon( "m1014_mp" );
//AUTO         iPrintlnBold( "^7" + player.name + " ^2Chose ^3Shotgun^7!" );
		wait 2;
//AUTO 		iPrintlnBold("3");
		wait 1;
//AUTO 		iPrintlnBold("2");
...
//AUTO 		iprintln("^1Playng:^7 Macklemore & Ryan Lewis - Thrift Shop Dubstep");
		player freezeControls(true);
		level.activ freezeControls(true);
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
...
//AUTO 		ambientplay("rpg");
//AUTO 		iprintln("^1Playng:^7 Avicii - Wake Me Up Dubstep");
...
//AUTO         iPrintlnBold( "^7" + player.name + " ^2Chose ^3RPG^7!" );
		wait 2;
//AUTO 		iPrintlnBold("3");
		wait 1;
//AUTO 		iPrintlnBold("2");
...
//AUTO 		iprintln("^1Playng:^7 *Dubstep* House of Pain - Jump Around");
		player freezeControls(true);
		level.activ freezeControls(true);
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
