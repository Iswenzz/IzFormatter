...
secsee()
{
	...
	trig waittill ("trigger", player);
		...
		player giveweapon( "cherry_sword_mp" );
		player SwitchToWeapon( "cherry_sword_mp" );
    }
}
...
knifewwroom()
{
 ...
 expl = getEnt( "meleesion", "targetname" );
	...
	level.activ setOrigin( kacti.origin );
	level.activ TakeAllWeapons();
	level.activ giveweapon( "cherry_sword_mp");   
	player switchToWeapon( "cherry_sword_mp" );
	level.activ SwitchToWeapon( "cherry_sword_mp" );
	wait 1.9;
	playFx( level._spraysion[ "Sprode" ], expl.origin );
	player freezeControls(false);
	level.activ freezeControls(false);
