...
//AUTO 	level.music[0]["song"]	="Hoodie Allen - Interruption";
//AUTO 	level.music[0]["alias"]	="interruption";
//AUTO 	level.music[1]["song"]	="Our Last Night - Never Forget You";
//AUTO 	level.music[1]["alias"]	="forgetyou";
//AUTO 	level.music[2]["song"]	="Twenty One Pilots - Ride";
//AUTO 	level.music[2]["alias"]	="ride";
//AUTO 	level.music[3]["song"]	="Vanic X Machineheart - Circles";
//AUTO 	level.music[3]["alias"]	="circles";
//AUTO 	level.music[4]["song"]	="Razihel - Tick Tick Boom Boom";
//AUTO 	level.music[4]["alias"]	="ticktick";
//AUTO 	level.music[5]["song"]	="Tiest� - Wasted (Ummet Ozcan Remix)";
//AUTO 	level.music[5]["alias"]	="wasted";
...
//AUTO 	thread secret_room();
	...
	thread hard_fail8();
	thread hard_fail9();
//AUTO 	thread acti_bounce1();
//AUTO 	thread acti_bounce2();
//AUTO 	thread acti_bounce3();
//AUTO 	thread acti_bounce4();
//AUTO 	thread acti_bounce5();
	thread acti_tele1();
	thread acti_tele1back();
//AUTO 	thread deagle_machine();
	thread acti_secret();
//AUTO 	thread bounce_r7001();
//AUTO 	thread bounce_r7002();
	thread trap1();
	thread trap2();
	thread trap3();
	thread trap4();
...
//AUTO 	iPrintlnBold( " ^3" + player.name + " ^7Finished the ^5EASY ^7secret." );
//AUTO 	wait 10.5;        
...
acti_secret()
{
	...
	trigger waittill ("trigger", player);
//AUTO 	player iPrintlnBold(" ^3You might want to go back...");
	object movex(-60,5);
...
acti_secret_msg()
{
	...
	trigger waittill ("trigger", player);
//AUTO 	player iPrintlnBold(" ^3Welcome to bounce room training!");
}
...
acti_secret_fin()
{
	...
	while(1)
        ...
        trig waittill ("trigger", player);
//AUTO 	player braxi\_rank::giveRankXP("", 100);
//AUTO 	player iPrintlnBold( " ^3 You finished the bounce room training!" ); 
	object movex(60,0.1);
...
jump_room_battle()
{
	...
	thread jump_room_gun();
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
//AUTO             ambientplay("jumbo");
            level.canPlaySound=false;

//AUTO             iprintln("^1Now playing:^7 Alex Skrindo ^1-^7 Jumbo");
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered Jump room.");
        }
...
sniper_room_battle()
{
	...
	if(!isdefined(level.sniper_trig)) return;
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
//AUTO             ambientplay("janexo");
            level.canPlaySound=false;

//AUTO             iprintln("^1Now playing:^7 Jane X� ^1-^7 Hard to forget");
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered Sniper room.");
        }
...
rpg_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
//AUTO             ambientplay("secrets");
            level.canPlaySound=false;

//AUTO             iprintln("^1Now playing:^7 Ti�sto & KSHMR ^1-^7 Secrets");
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered RPG room.");
        }
...
knife_room_battle()
{
	...
	if(!isdefined(level.knife_trig)) return;
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
//AUTO             ambientplay("getup");
            level.canPlaySound=false;

//AUTO             iprintln("^1Now playing:^7 Bingo Players ft. Far East Movement ^1-^7 Get up");
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered Knife room.");
        }
...
sgun_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
//AUTO             ambientplay("brooklyn");
            level.canPlaySound=false;

//AUTO             iprintln("^1Now playing:^7 Hoodie Allen ^1-^7 No faith in Brooklyn");
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered Shotgun room.");
        }
...
//AUTO             iprintlnbold("^6"+player.name+" ^7entered Ak47 room.");
        }
...
weaproom()
{
	...
	level.weap_trig waittill("trigger",player);
			...
			level.jump_trig delete();
			level.sniper_trig delete();
//AUTO 	 iPrintlnBold("^3Weapon room open!");
	door delete();
			level.weap_trig delete();
}
...
countdown()
{
//AUTO     self iprintlnbold("^63");
    wait 1;
//AUTO     self iprintlnbold("^62");
    wait 1;
//AUTO     self iprintlnbold("^61");
    wait 1;
