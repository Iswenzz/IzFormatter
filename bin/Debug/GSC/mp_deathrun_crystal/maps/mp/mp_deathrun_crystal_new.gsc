...
{
wait 7;
//AUTO iprintln("^5>>^7eBc|Legend Welcomes you on mp_deathrun_crystal");
wait 17;
//AUTO iprintln("^5>>^7Map Creator ^1eBc|Legend");
wait 21;
//AUTO iprintln("^5>>^7Thanks For Playng Crystal");
wait 21;
//AUTO iprintln("^5>>^7Have Fun and Enjoj the ^1C^2r^3y^4s^5t^6a^7l^8s");
wait 1;
}
...
{
dj_bord delete();
//AUTO iprintln("^5>>^7Song: ^2Snoop ^0Dog^7 Smoke^2 Weed ^7Everyday");
//AUTO iprintlnbold("^5" + user.name + " ^7Turns Music On!!");
//AUTO ambientplay("weed");
wait 1;
}
}
...
//AUTO 		iprintln("^1Playng:^7 Nightcore - Can't Controle MySelf");
//AUTO         iPrintlnBold( "^7" + player.name + " Entered ^4Sniper" );
...
//AUTO 		ambientplay("shotgun");
//AUTO 		iprintln("^1Playng:^7 Nightcore - Angel With A Shotgun");
//AUTO         iPrintlnBold( "^7" + player.name + " Entered ^8Shotgun" );
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
//AUTO 		player TakeAllWeapons();
        level.activ setPlayerangles( acti.angles );
...
//AUTO 		iprintln("^1Playng:^7 Nightcore - A+ SuperStar");
		player freezeControls(true);
		level.activ freezeControls(true);
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
...
//AUTO         iPrintlnBold( "^7" + player.name + " Entered ^6Knife" );
//AUTO 		wait 2;
//AUTO 		iPrintlnBold("3");
//AUTO 		wait 1;
//AUTO 		iPrintlnBold("2");
...
//AUTO 		level.activ iprintln("^5You'r Weapons Are Removed");
//AUTO         iPrintlnBold( " ^4" + player.name + "^7 Entered ^0OLD!" );
//AUTO 		wait 5;
		old_door delete();
        while( isAlive( player ) && isDefined( player ) )
//AUTO         wait 1;
...
//AUTO 		iprintln("^1Playng:^7 Nightcore - Jump Jump");
		player freezeControls(true);
		level.activ freezeControls(true);
        player SetPlayerAngles( jump.angles );
        player setOrigin( jump.origin );
...
//AUTO         player switchToWeapon( "deserteagle_mp" );
//AUTO         level.activ SwitchToWeapon( "deserteagle_mp" );
//AUTO         iPrintlnBold( " ^7" + player.name + " Entered ^3Jump" );
//AUTO 		wait 2;
//AUTO 		iPrintlnBold("3");
//AUTO 		wait 1;
//AUTO 		iPrintlnBold("2");
...
trigger = GetEnt( "finish", "targetname" );
	...
	trigger waittill ("trigger", user);
		{
//AUTO 		iprintlnbold( "^7" + user.name + " ^5F^7inished ^5F^7irst");
		wait 4;
		}
	}
}
...
trigger waittill ("trigger",user);
wait(0.2);
//AUTO user iprintlnbold("You Have Taken [^4R700^7]");
wait(0.1);    
