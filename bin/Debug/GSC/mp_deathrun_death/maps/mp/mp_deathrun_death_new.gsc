...
//AUTO 		who iprintlnbold("^2Whats the point of glitching? Its boring! You got saved!");
//AUTO 		who iprintlnbold("^2Little Notice: ^1GET A LIFE!");
//AUTO 		iprintlnBold( who.name + " tried to glitch!");
//AUTO 		logPrint( who.name + " tried to glitch! ( Guid: " + who GetGuid() + " )");
...
//AUTO 	iprintlnbold( player.name + " ^1finished the map as first! ^2Gratz!");
	
	if( !level.freeRun && isDefined( level.activ ) && isAlive( level.activ ) )
	{
//AUTO 		iprintln("Activator got teleported to randomly spot!");
...
//AUTO 		level.activ iprintlnbold("You got teleported to randomly spot!");
	}
	...
	while(1)
	{
		if( self GetCurrentWeapon() == "portal_mp" )
		{
			if( self AttackButtonPressed() )
			{
				...
				{
//AUTO 					self iprintlnbold("Portal would be too close to the other one!");
					wait 0.1;
					continue;
				}
...
//AUTO 			owner iprintln("You got teleported!");
			wait 0.5;
		}
...
//AUTO 	player iprintlnbold( player.name + " pressed a pointless button...");
...
//AUTO 	player iprintlnbold("^1YOU PICKED UP THE PORAL GUN! ^2HAVE FUN");
//AUTO 	player iprintlnbold("^1Attack Button = 1st portal^7 ; ^22x ADS Button = 2nd portal");
//AUTO 	player iprintlnbold("^5Frag Button = delete portals");
	
//AUTO 	player GiveWeapon("portal_mp");
	wait 0.01;
//AUTO 	player SwitchToWeapon("portal_mp");
