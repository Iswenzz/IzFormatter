...
StartFinalRoom( i, place )
{
	...
	iprintlnbold( "^1=== ^7Special Fight ^1===" );
	iprintlnbold( "^1"+ activator.name +"^7 as a ^1MONSTER" );
	...
	for(i = 0;i < size;i++)
	{
		...
		iprintlnbold( "^1"+ player.name +"^7 as a ^1VICTIM" );
	}
	...
	for(i = 0;i < players.size;i++)
	{
		...
		player SwitchToWeapon( player.weapon );
	}
	...
	while( true )
	{
		...
		{
			iprintlnbold( "Player ^1"+ eAttacker.name +" ^7get ^1400 ^7XP for killing activator." );
			eAttacker braxi\_rank::giveRankXP( "coin", 400 );
		}
	}
}
