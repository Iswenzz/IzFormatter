main()
{
	...
	portals = getentarray("teleport3", "targetname");
...
Transporter2Random(portals, inx)
{
	...
	while( isdefined( level.teleport_teleport3 ) || !i )
	{
		level waittill( "picking activator" );
	
		i++;
		level.teleport_teleport3 = undefined;
		...
		while(true)
		{
			...
			if( isdefined(level.teleport_teleport3) )
				break;
