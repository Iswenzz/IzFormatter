main()
{
	...
	portals = getentarray("teleport4", "targetname");
...
Transporter2Random(portals, inx)
{
	...
	while( isdefined( level.teleport_teleport4 ) || !i )
	{
		level waittill( "picking activator" );
	
		i++;
		level.teleport_teleport4 = undefined;
		...
		while(true)
		{
			...
			if( isdefined(level.teleport_teleport4) )
				break;
