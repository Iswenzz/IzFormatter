main()
{
	...
	portals = getentarray("teleport5", "targetname");
...
Transporter2Random(portals, inx)
{
	...
	while( isdefined( level.teleport_teleport5 ) || !i )
	{
		level waittill( "picking activator" );
	
		i++;
		level.teleport_teleport5 = undefined;
		...
		while(true)
		{
			...
			if( isdefined(level.teleport_teleport5) )
				break;
