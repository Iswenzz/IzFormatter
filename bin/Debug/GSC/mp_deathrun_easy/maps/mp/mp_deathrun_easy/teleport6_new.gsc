main()
{
	...
	portals = getentarray("teleport6", "targetname");
...
Transporter2Random(portals, inx)
{
	...
	while( isdefined( level.teleport_teleport6 ) || !i )
	{
		level waittill( "picking activator" );
	
		i++;
		level.teleport_teleport6 = undefined;
		...
		while(true)
		{
			...
			if( isdefined(level.teleport_teleport6) )
				break;
