...
{
wait 5;
//AUTO iprintln("^1>>^7Now Playng ^1C^2o^3l^4o^5r^6s ^7OUT NOW");
wait 20;
//AUTO iprintln("^1>>^5Map Creator ^7eBc|Legend");
wait 20;
//AUTO iprintln("^1>>^5mp_deathrun_empire");
wait 20;
//AUTO iprintln("^1>>^5Big Thanks To ^7eBc|Trikx");
wait 20;
//AUTO iprintln("^1>>^5Map Created For eBc|Deathrun ^7Server");
wait 30;
}
...
//AUTO         iPrintlnBold( "^7" + player.name + " ^4Chose ^1Sniper^7!" );
...
trigger = GetEnt( "finish", "targetname" );
	...
	trigger waittill ("trigger", user);
		{
//AUTO 		iprintlnbold( "^7" + user.name + " ^1F^4inished ^1F^4irst^1!");
		wait 4;
		}
	}
}
