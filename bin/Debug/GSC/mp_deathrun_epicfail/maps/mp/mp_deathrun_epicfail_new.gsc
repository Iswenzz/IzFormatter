...
//AUTO 		//player thread braxi\_rank::giveRankXP("trap_activation",100);
		wait .05;
	}
}
...
//AUTO 	player playLocalSound("mp_enemy_obj_captured");
//AUTO 	player iPrintln("^2You Have Found The Gold Deagle!!");
...
trap5Death()
{
	...
	while(1)
	{
/* AUTO 		brush waittill("trigger",player);
		player suicide();
	}
*/}
