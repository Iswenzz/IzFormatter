...
enddoor21()
{
            ...
            {
            brush moveZ(240,3);
//AUTO             iPrintlnBold( " ^5" + player.name + " has finished the map!" );
            }
}
...
//AUTO 		iPrintlnBold( " ^1" + player.name + " has chosen Sniper room!" );			
...
//AUTO 		iPrintlnBold( " ^2" + player.name + " has chosen Tomahawk room!" );		
		while( isAlive( player ) && isDefined( player ) )
			wait 1;
	}
}
...
game2()
{
	...
	while(1)
	{
		...
		player setOrigin( jump.origin );
//AUTO 		player TakeAllWeapons();
//AUTO 		player GiveWeapon( "m1014_reflex_mp" );		
		level.activ setPlayerangles( acti.angles );
		level.activ setOrigin( acti.origin );
//AUTO 		level.activ TakeAllWeapons();
...
GoldBoltmech()
{
            ...
            trig delete();
            {
//AUTO             iPrintlnBold( " ^5" + player.name + " has found the ^3 GoldBolt!" );
             wait 3;
             {
