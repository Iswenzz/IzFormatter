...
//AUTO 	//iPrintLn( user.name, deathmetod1);
	musicplay ("music_end");
...
//AUTO level._effect[ "weather" ] = loadfx( "weather/big_cloud_bank" );
...
//AUTO 		iprintlnbold("^2SNIPER ^7DUEL!");
		wait 2;
//AUTO 		iprintlnbold("^1EPIC HEAVEN FIGHT^7!");
...
//AUTO 					players[i] GiveWeapon("dragunov_mp");
					wait 0.01;
//AUTO 					players[i] SwitchToWeapon("dragunov_mp");
