...
credits()
{
     for(;;)
	 {
//AUTO 	 iPrintLn ("^3>>^1Map By Sheep Wizard");
	 wait 7;
//AUTO 	 iPrintLn ("^3>>^1Youtube paap15");
	 wait 7;
//AUTO 	 iPrintLn ("^3>>^1Xfire paap15");
	 wait 7;
//AUTO 	 iPrintLn ("^3>>^1FeZe Clan");
	 wait 7;
//AUTO 	 iPrintLn ("^3>>^2Thanks to all the people who helped test the map^6<3^2!");
	 wait 7;
//AUTO 	 iPrintLn ("^3>>^1Thanks for playing ^3mp_deathrun_Fluxx, ^1Hope you enjoy!");
	 wait 14;
	 }
}
...
start()
{
     wait 6;
	 musicPlay("meow");
//AUTO 	 iPrintLn ("^3>>^1<<^6Now playing: ^2sayCet - Dinofly^1>>");
}
...
//AUTO 	 level.activ TakeAllWeapons();
//AUTO 	 player TakeAllWeapons();
//AUTO 	 level.activ giveweapon( "colt45_silencer_mp");
//AUTO 	 player giveweapon( "colt45_silencer_mp");
//AUTO 	 player switchToWeapon( "colt45_silencer_mp" );
//AUTO 	 level.activ SwitchToWeapon( "colt45_silencer_mp" );
//AUTO 	 player giveMaxAmmo( "colt45_silencer_mp" );
//AUTO 	 level.activ giveMaxAmmo( "colt45_silencer_mp" );
