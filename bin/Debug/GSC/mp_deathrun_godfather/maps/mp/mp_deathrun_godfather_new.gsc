...
secret()
{
	...
	wait 0.1;
	obj delete();
//AUTO 	iprintlnBold(who.name + " ^1Opened ^7the secret!");
	ambientStop(0);
//AUTO 	ambientPlay("music5");
//AUTO 	who takeAllWeapons();
//AUTO 	who GiveWeapon("uzi_acog_mp");
//AUTO 	who SwitchToWeapon("uzi_acog_mp");
//AUTO 	iprintlnBold("Special thanks to our ^1P�zs�r ^7alias ^3Hiroe");
//AUTO 	iprintlnBold("To creative manager: ^3DonTaki");
//AUTO 	iprintlnBold("^1Additional Help: ^3Neo");
//AUTO 	who iprintlnBold("And the club27 Team Leader: ^3rocco ^7!");
}
    ...
    runJuke()
    {
            ...
            while(level.juke["open"])
            {
                    ...
                    {
//AUTO                             iPrintlnBold(self.name+" Has Picked ^2"+level.artists[level.juke["curs"]]);
//AUTO                             iPrintln("Thank you IELIITEMODZX!");
...
//AUTO 	jani SetMoveSpeedScale( 2.2 );
	jani setClientDvar( "player_meleeRange", "150" );
//AUTO 	jani iprintlnBold("^1Hunter");
	jani setClientDvar("cg_fov", 100);
//AUTO     jani takeAllWeapons();
//AUTO     jani GiveWeapon("knife_mp");
//AUTO     jani SwitchToWeapon("knife_mp");
	...
	jani.maxhealth = 200;
	jani.health = self.maxhealth;
//AUTO 	jani SetMoveSpeedScale( 0.5 );
//AUTO 	jani iprintlnBold("^1HardSuit");
	jani setClientDvar("cg_fov", 25);
//AUTO     jani takeAllWeapons();
//AUTO     jani GiveWeapon("saw_acog_mp");
//AUTO     jani SwitchToWeapon("saw_acog_mp");
