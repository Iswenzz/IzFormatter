...
nyanmove()
{
	...
	trig waittill( "trigger", who );
//AUTO 	iprintlnbold("^2NYAN CATTY ^1INCOMING!!!");
	trig delete();
...
mannequin()
{
	...
	trig waittill( "trigger", who );
//AUTO 	iprintlnbold("^0Mannequins? ^2wtf");
	trig delete();
...
//AUTO 	iprintlnbold("" + " " + "^1"+ player.name + " "+ "^7is a ^1NOOB");
	wait 1;
	player suicide();
	trig delete();
