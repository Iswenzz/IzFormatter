...
text()
{
	for(;;)
	{
//AUTO 		iprintln("Map made by ^5FearZ");
		wait 60;
	}
}
...
//AUTO 			iprintln ("Map maker " + players[i].name + " joined the game");
		}
	}
}
...
helicopter()
{
	...
	helicopter1 show();
	helicopter2 show();	
//AUTO 	iprintlnbold (player.name + " choosen helicopter wars!");
...
//AUTO 	iprintlnbold ("helictoper battle!");
...
//AUTO 	iPrintLnbold ("1");
	wait 1;
//AUTO 	iPrintLnbold ("Begin! Good luck!");
//AUTO 	player GiveWeapon("m14_mp");
//AUTO 	player SwitchToWeapon("m14_mp");
...
bounce()
{
	...
	trig waittill ("trigger", player);
//AUTO 	iprintlnbold (player.name + " choosen bounce!");
...
//AUTO 	iprintlnbold ("Knife battle!");
	wait 1;
//AUTO 	iPrintLnbold ("3");
	wait 1;
//AUTO 	iPrintLnbold ("2");
...
sniper()
{
	...
	trig waittill ("trigger", player);
//AUTO 	iprintlnbold (player.name + " choosen sniper!");
...
comb()
{
	...
	for(;;)
	{
		comb hide();
		wait 40;
//AUTO 		iprintln("Trap comb is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " used the comb!");
		comb show();
...
gay()
{
	...
	for(;;)
	{
		...
		wait 50;
//AUTO 		iprintln("Trap gay detector is ready!");
		trig waittill ("trigger", player);
		trig delete();
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " used the gay trap, watch out!");
		...
		{	
			...
			player freezecontrols (1);
			wait 1;
//AUTO 			player iprintlnbold("You have been choosen by the gay detector");
//AUTO 			iPrintLnBold(player.name + " has been choosen by the gay detector");
			wait 1;
...
slide()
{
	...
	for(;;)
	{
		...
		slide2 hide();
		wait 30;
//AUTO 		iprintln("Trap slide is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " used the slide!");
...
plane()
{
	...
	for(;;)
	{
		...
		plane2 hide();
		wait 35;
//AUTO 		iprintln("Trap plane is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " started the plane, watch out!");
		trig delete();
...
helecopter()
{
	...
	{
		wait 40;
//AUTO 		iprintln("Trap helicopter is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " started the helicopter, watch out!");
		trig delete();
...
mortar()
{
	...
	{
		wait 25;
//AUTO 		iprintln("Trap mortar is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " activated the mortar!");
...
fan()
{
	...
	for(;;)
	{
		fan hide();
		wait 25;
//AUTO 		iprintln("Trap fan is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " activated the fan!");
...
splatter()
{
	...
	for(;;)
	{
		...
		splitter hide();
		wait 15;
//AUTO 		iprintln("Trap splatter is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " activated the splatter!");
...
spinner()
{
	...
	for(;;)
	{
		spin hide();
		wait 10;
//AUTO 		iprintln("Trap spinner is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " activated the spinner!");
		spin moveZ(208,1);
		wait 2;
		while(1)
		{
...
spinner2()
{
	...
	for(;;)
	{
		spin hide();
		wait 30;
//AUTO 		iprintln("Trap faster spinner is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " activated the faster spinner!");
		spin moveZ(208,1);
		wait 2;
		while(1)
		{
...
pusher()
{
	...
	for(;;)
	{
		...
		push4 hide();
		wait 10;
//AUTO 		iprintln("Trap pusher is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " Activated the pushers!");
...
pusher2()
{
	...
	for(;;)
	{
		...
		push4 hide();
		wait 30;
//AUTO 		iprintln("Trap faster pusher is ready!");
		trig waittill ("trigger", player);
...
//AUTO 		player iprintlnbold("You must wait 15 seconds to use another trap");
//AUTO 		iPrintLnBold (player.name + " Activated the faster pushers!");
