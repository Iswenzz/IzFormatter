...
//AUTO   addTriggerToList( "sniperammo_trig" );
...
//AUTO 		player iprintlnbold (" you feel different?! ");
...
//AUTO 		iPrintLnBold(player.name+ "^2 has found the secret room!");
	}
}
...
//AUTO 		player giveweapon( "g36c_mp" );
//AUTO 		player giveMaxAmmo( "g36c_mp" );
//AUTO 		player SwitchToWeapon( "g36c_mp" );
		player playsound("mp_enemy_obj_captured");
	}
}
...
sniperammo() 
{
	...
	trig waittill("trigger", player);
	wait 5;
//AUTO 	player giveMaxammo("m40a3_acog_mp");
	}
}
...
creator()
   {
	...
	wait 10;
//AUTO 	iPrintLnBold("^2Map by ^5IceOps|*V*");
   }
