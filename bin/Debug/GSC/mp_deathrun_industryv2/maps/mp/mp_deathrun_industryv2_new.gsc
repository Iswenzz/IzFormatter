...
//AUTO 	precachemodel("weapon_colt1911_black");
//AUTO 	precachemodel("weapon_g3");
//AUTO 	precachemodel("weapon_ak74u");
...
triggertodestroy()
{
	...
	while(isdefined(triggertodestroy))
	{
		...
		if(doorhealth > 300)
//AUTO 			iprintln("[^5Industry_v2^7]: Doors Stabilisation Left ^2"+doorhealth);
		if(doorhealth < 300 && doorhealth > 200)
//AUTO 			iprintln("[^5Industry_v2^7]: Doors Stabilisation Left ^3"+doorhealth);
		if(doorhealth < 200 && doorhealth >= 0)
//AUTO 			iprintln("[^5Industry_v2^7]: Doors Stabilisation Left ^1"+doorhealth);
...
//AUTO 	theone iprintlnbold("You sided with the activator, kill the jumpers!!");
//AUTO 	iprintln("[^5Industry_v2^7]: "+theone.name+" Sided With The Activator Kill Him Befor He Kill You!");
//AUTO 	theone giveweapon("ak47_mp");
//AUTO 	theone switchtoweapon("ak47_mp");
//AUTO 	theone givemaxammo("ak47_mp");
	theone setmodel("body_mp_usmc_cqb");
	}
	else
//AUTO 		{iprintln("[^5industry_v2^7]: Wrong pick"); thread strap1thing();}
}
...
strap2thing()
{
	...
	{
//AUTO 		theone iprintlnbold("You Are Finishing Damage Around You!!");
		theone.strap2 = true;
...
//AUTO 		{iprintln("[^5industry_v2^7]: Wrong pick"); thread strap2thing();}
}
...
trap3kill()
{
	...
	self.actied3 = false;
//AUTO 	self iprintlnbold("^5Freeze Time Is Over");
...
trap12()
{
	...
	if(x < 10)
	{
//AUTO 		player iprintlnbold("Platform 1 is not solid");
	...
	if(x < 20 && x > 10)
	{
//AUTO 		player iprintlnbold("Platform 2 is not solid");
	...
	if(x < 30 && x > 20)
	{
//AUTO 		player iprintlnbold("Platform 3 is not solid");
	...
	if(x < 40 && x > 30)
	{
//AUTO 		player iprintlnbold("Platform 1 & 2 are not solid");
		level.plat1 notsolid();
		level.plat2 notsolid();
		wait time;
		level.plat1 solid();
	...
	if(x < 50 && x > 40)
	{
//AUTO 		player iprintlnbold("Platform 2 & 3 are not solid");
		level.plat2 notsolid();
		level.plat3 notsolid();
		wait time;
		level.plat2 solid();
	...
	if(x < 60 && x > 50)
	{
//AUTO 		player iprintlnbold("Platform 1 & 3 are not solid");
		level.plat1 notsolid();
		level.plat3 notsolid();
		wait time;
		level.plat1 solid();
	...
	if(x <= 70 && x > 60)
	{
//AUTO 		player iprintlnbold("Platforms 1 & 2 & 3 are not solid");
		level.plat1 notsolid();
		level.plat2 notsolid();
		level.plat3 notsolid();
		wait time;
...
//AUTO 			iprintlnbold("^5* * ^2Creator ^3" + player.name + " ^2has Joined^1!^5 * *");
		}
	}
}
...
//AUTO 			self iprintlnbold("[^1no cheating in knife room bitch, bullets set to 0!^7]");
		}
...
//AUTO 			self iprintlnbold("[^1admin abuse op, learn to play bitch!^7]");
		}
		wait .1;
	}
}
...
//AUTO 			player iprintlnbold("You already have this rifle");
...
onendround()
{
	...
	for(i=0;i<=players.size;i++)
	{
		...
		{
//AUTO 			players[i] iprintlnbold("^5You Have ^10 ^5Kills :(, Reward: ^150 XP ");
//AUTO 			players[i] braxi\_rank::giveRankXp( undefined, 50 );
		}

		if(players[i].pers["kills"] >= 5 && players[i].pers["kill"] < 7)
		{
//AUTO 			players[i] iprintlnbold("^5You Have More or ^15 ^5Kills, Reward: ^1200 XP");
//AUTO 			players[i] braxi\_rank::giveRankXp( undefined, 200 );
		}

		if(players[i].pers["kills"] >= 7 && players[i].pers["kill"] < 10)
		{
//AUTO 			players[i] iprintlnbold("^5You Have More or ^17 ^5Kills, Reward: ^1500 XP");
//AUTO 			players[i] braxi\_rank::giveRankXp( undefined, 500 );
		}

		if(players[i].pers["kills"] >= 10)
		{
//AUTO 			players[i] iprintlnbold("^5You Have More or ^110 ^5Kills, Reward: ^11000 XP");
...
//AUTO 			player givemaxammo("deserteaglegold_mp");
	...
	if(num == 6)
	{
		...
		{
			self waittill("trigger",player);
//AUTO 			player GiveWeapon("dragunov_mp");
//AUTO 			player switchtoweapon("dragunov_mp");
//AUTO 			player givemaxammo("dragunov_mp");
			wait .1;
		}
	}
	if(num == 7)
...
//AUTO 			player givemaxammo("g3_mp");
	...
	if(num == 8)
	{
		...
		{
			self waittill("trigger",player);
//AUTO 			player GiveWeapon("m4_mp");
//AUTO 			player switchtoweapon("m4_mp");
//AUTO 			player givemaxammo("m4_mp");
			wait .1;
		}
	}
	if(num == 9)
