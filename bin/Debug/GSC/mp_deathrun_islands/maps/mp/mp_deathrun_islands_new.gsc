...
//AUTO 	 maps\mp\mp_deathrun_island\endrooms::main();
...
//AUTO player iprintlnbold("^1HOW DARE YOU TAKE ^2TIM'S ^1WEAPON!!");
wait 0.8;
//AUTO player iprintlnbold("^1YOU WILL BE CURSED!!");
wait 1;
...
//AUTO player iprintlnbold("^1Creating life...");
wait 1;
player.health = 80;
wait 1;
player.health = 60;
...
//AUTO 			player iprintln("Hey Sheep");
...
trig waittill("trigger", player);
trig delete();
//AUTO player giveweapon( "m14_silencer_mp");
//AUTO player switchToWeapon( "m14_silencer_mp" );
}
...
//AUTO 	 iPrintLn ("^1>>^3Xfire: paap15");
	 wait 7;
//AUTO 	 iPrintLn ("^1>>^3Thanks to Darmuh + Blade");
	 wait 7;
//AUTO 	 iPrintLn ("^1>>^3Thanks to FeZe Dench (Rickster) for helping test map");
	 wait 7;
//AUTO 	 iPrintLn ("^1>>^3Thanks for playing ^2mp_deathrun_islands, ^3Hope you enjoy!");
	 wait 7;
//AUTO 	 iPrintLn ("^1>>^3Thanks to FeZe Dench (Rickster) for helping test map");
	 wait 7;
	 }
