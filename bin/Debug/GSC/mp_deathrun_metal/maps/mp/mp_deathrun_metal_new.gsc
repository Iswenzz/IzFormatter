...
//AUTO 	iprintlnbold ("NICE" + ", " + "^2"+ player.name + "^7 FINISHED FIRST!");
	trig delete();
}
...
//AUTO 	iprintlnbold(player.name + " ^1choosed the knife fight!");
...
teleport1()
{
	...
	while(1)
	{
		...
		if( getTeamPlayersAlive("allies") == 1 )
		{
			trig thread weapon();
			trig thread ammobox();
//AUTO 			iprintlnbold(who.name + " ^1choosed the weapon fight!");
			//self delete();
			break;
		}
		if( getTeamPlayersAlive("allies") > 1 )
...
//AUTO 	acti TakeAllWeapons();
	...
	if( x < 10 )
		{
//AUTO 		acti GiveWeapon( "rpg_mp" );
//AUTO 		jumper GiveWeapon( "rpg_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "rpg_mp" );
//AUTO 		jumper SwitchToWeapon( "rpg_mp" );
		}
	if( x > 9 && x < 20 )
		{
//AUTO 		acti GiveWeapon( "winchester1200_mp" );
//AUTO 		jumper GiveWeapon( "winchester1200_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "winchester1200_mp" );
//AUTO 		jumper SwitchToWeapon( "winchester1200_mp" );
		}
	if( x > 19 && x < 30 )
		{
//AUTO 		acti GiveWeapon( "m40a3_acog_mp" );
//AUTO 		jumper GiveWeapon( "m40a3_acog_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "m40a3_acog_mp" );
//AUTO 		jumper SwitchToWeapon( "m40a3_acog_mp" );
		}
	if( x > 29 && x < 40  )
		{
//AUTO 		acti GiveWeapon( "mp44_mp" );
//AUTO 		jumper GiveWeapon( "mp44_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "mp44_mp" );
//AUTO 		jumper SwitchToWeapon( "mp44_mp" );
		}
	if( x > 39 && x < 50  )
		{
//AUTO 		acti GiveWeapon( "deserteaglegold_mp" );
//AUTO 		jumper GiveWeapon( "deserteaglegold_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "deserteaglegold_mp" );
//AUTO 		jumper SwitchToWeapon( "deserteaglegold_mp" );
		}
	if( x > 49  )
		{
//AUTO 		acti GiveWeapon( "saw_grip_mp" );
//AUTO 		jumper GiveWeapon( "saw_grip_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "saw_grip_mp" );
//AUTO 		jumper SwitchToWeapon( "saw_grip_mp" );
		}
...
enddoors2()
{
	...
	trig waittill ("trigger",who);
	trig delete();
//AUTO 	iprintlnbold(who.name + " ^1choosed the old way!");
	door2 movez ( 114,0.1);
	wait 2;
	sound playsound ("door_start");
	door4 movez ( -94,1.5);
...
//AUTO 	iprintlnbold( who.name + "^2 found a secret nuke launcher!");
	

	trig waittill ("trigger",acti);
	trig delete();
//AUTO 	AmbientPlay( "alert" );
...
//AUTO 	AmbientPlay( "incom" );
//AUTO 	wait 1;
	PlayFX( level.tracer_fx, bomb.origin );
//AUTO 	wait 1;
//AUTO 	AmbientPlay( "boom" );
	thread nuke();
//AUTO 	wait 7;
	players = getentarray("player", "classname");
	for(i=0;i<players.size;i++)
