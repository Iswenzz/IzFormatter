...
//AUTO 	iprintlnbold("Uh yeah " + " " + "^1"+ player.name + " "+ "^7finished the map!");
	trig delete();

	finishdoor movez( -200, 10 );
//AUTO 	AmbientPlay( "finish" );
	PlayFX( level.final_fx, (-656,1524,-32) );
//AUTO 	player TakeAllWeapons();
//AUTO 	player giveWeapon("pickaxe_mp");
	wait 0.01;
//AUTO 	player SwitchToWeapon("pickaxe_mp");
...
ding()
{
	...
	trig waittill( "trigger", player );
//AUTO 	iprintlnbold("^2OooOoOoh" + " " + "^1"+ player.name + " "+ "^7touched my tralala!");
	trig delete();
//AUTO 	AmbientPlay( "ding" );
	pedo movez( 1500, 25 );
	wait 30;
//AUTO 	iprintlnbold("And now " + " " + "^1"+ player.name + " "+ "^7is my lovetoy!!!");
	wait 15;
//AUTO 	iprintlnbold("Gunther is looking for:" + " " + "^1"+ player.name + " "+ "^7....where is he?");
	wait 15;
//AUTO 	iprintlnbold("I miss you:" + " " + "^1"+ player.name + " "+ "^7xoxo Gunther");
	wait 15;
//AUTO 	iprintlnbold("Gunther is hoping: " + " " + "^1"+ player.name + " "+ "^7is CUMMING soon!");
	wait 15;
//AUTO 	iprintlnbold("Whow" + " " + "^1"+ player.name + " "+ "^7your are SO HOT!!!!");
	wait 15;
//AUTO 	iprintlnbold("" + " " + "^1"+ player.name + " "+ "^7you make Gunther very horny! Watch out!");
	wait 15;
//AUTO 	iprintlnbold("Hehee" + " " + "^1"+ player.name + " "+ "^7has some HUGE Pen... eh problems!");
	wait 15;
//AUTO 	iprintlnbold("Oh" + " " + "^1"+ player.name + " "+ "^7is pretty much fucked...REALLY fucked..by Gunther");
...
//AUTO 	acti TakeAllWeapons();
	...
	if( x < 10 )
		{
//AUTO 		acti GiveWeapon( "pickaxe_mp" );
//AUTO 		jumper GiveWeapon( "pickaxe_mp" );
		wait 0.01;
//AUTO 		acti SwitchToWeapon( "pickaxe_mp" );
//AUTO 		jumper SwitchToWeapon( "pickaxe_mp" );
		}
	if( x > 9 && x < 20 )
		{
//AUTO 		acti GiveWeapon( "pickaxe_mp" );
...
saturday()
{
	...
	trig waittill( "trigger", player );
	trig delete();
//AUTO 	AmbientPlay( "saturday" );
//AUTO 	iprintlnbold("OMFG" + " " + "^1"+ player.name + " "+ "^7found Rebecca Black!");
