...
//AUTO 	precachemodel("weapon_remington700");
...
//AUTO 	level.shotgun = loadfx("muzzleflashes/winch_flash_wv");
...
//AUTO 	game["music_menu"] = "music_menu";
//AUTO 	precachemenu(game["music_menu"]);
...
//AUTO 	level.music=[];
//AUTO 	level.music["img"][0]="nk_song1";
//AUTO 	level.music["name"][0]="Linkin Park - Burn It Down";
//AUTO 	level.music["img"][1]="nk_song3";
//AUTO 	level.music["name"][1]="Boulevard of Broken Dreams";
//AUTO 	level.music["img"][2]="nk_song1";
//AUTO 	level.music["name"][2]="Linkin Park - What I've Done";
//AUTO 	level.music["img"][3]="nk_song2";
//AUTO 	level.music["name"][3]="Skillet - Hero";
//AUTO 	level.music["img"][4]="nk_song2";
//AUTO 	level.music["name"][4]="Skillet - Whispers in the Dark";
...
//AUTO 	thread pistolroom();
//AUTO 	thread speedrunroom();
	thread lilsec();
}
...
dodis(num)
{
	...
	if(x >= 25)
	{
		...
		self delete();
		player suicide();
//AUTO 		player iprintlnbold("^1You Just Got A Suicide!");
	}
	if(x < 25)
	{
		self sethintstring("What Does This Button Do?");
...
//AUTO 		player iprintlnbold("^2You Just Got A Life");
	}
}
...
//AUTO 	player openmenu("music_menu");
}
...
playmusic(song)//blade
{
	...
	switch(song)
	{
//AUTO 		case 0:	ambientplay("music1");	break;
//AUTO 		case 1:	ambientplay("music2");	break;
//AUTO 		case 2:	ambientplay("music3");	break;
//AUTO 		case 3:	ambientplay("music4");	break;
//AUTO 		case 4:	ambientplay("music5");	break;
	}
...
//AUTO 		self switchToWeapon("deserteagle_mp");
	...
	if(x == 1)
	{
//AUTO 		self GiveWeapon("beretta_mp");
//AUTO 		self givemaxammo("beretta_mp");
//AUTO 		self switchToWeapon("beretta_mp");
	}
	if(x == 2)
	{
//AUTO 		self GiveWeapon("colt45_mp");
//AUTO 		self givemaxammo("colt45_mp");
//AUTO 		self switchToWeapon("colt45_mp");
	}
	if(x == 3)
	{
