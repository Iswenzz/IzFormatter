...
//AUTO 	iprintlnbold("^7Start door has ^3opened^7.");
}
...
//AUTO 		player iprintlnbold( "Render says ^1you're bad^7 and you should feel ^1bad^7!" );
//AUTO 		wait 2;
//AUTO 		player iprintlnbold( "MWAHAHAHA" );
	}
}	
...
//AUTO 		iprintlnbold( "^5" + player.name + " ^7has found a shortcut." );
//AUTO 		wait 2;
	}
}	
...
//AUTO 		iprintlnbold( "^5" + self.name + " ^7has^1 died^7!" );
