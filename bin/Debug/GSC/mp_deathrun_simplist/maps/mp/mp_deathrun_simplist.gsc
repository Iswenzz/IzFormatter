...
main()
{
 ...
 start()
 {
	 ...
	 iPrintLn ("^2Map by ^6Sheep Wizard");
	 wait 1;
	 iPrintLn ("^2Youtube ^1http://www.youtube.com/user/paap15");
	 wait 0.5;
	 iPrintLn ("^2xfire ^1paap15");
	 wait 0.5;
	 iPrintLn ("^2Thanks you ^1Spicy Weiner ^2For emotional support");
	 wait(5);
	 ...
	 ambientPlay("music1");//disbale this is you want
	 iPrintLn ("^3Song ^4xKore ft. Zoe & Naomi - Need You (Centra 100BPM Remix)"); //link http://www.youtube.com/watch?v=3pS_cgCKD-0
}
...
secret()//find me if you can
{
	 ...
	 player giveWeapon ("rpg_mp", 1 );
	 wait 0.01;
	 player SwitchToWeapon("rpg_mp");
	 user iprintlnbold("A gift from me to you :D");
	 user iPrintLn("Enjoy the picture ;)");
...
end()//end room add more weapons if you wish
{
	 ...
	 iprintlnbold("^2"+ player.name + " "+ "^1Finished ^2First");//change this if you want
     ...
     else if(x == 2)
	 {
	     ...
	     level.activ TakeAllWeapons();
	     level.activ giveWeapon ("dragunov_acog_mp" );
		}
     else if(x == 3)
	 {
