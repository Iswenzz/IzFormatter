...
//AUTO 	player iprintln ("^4Add me in Xfire ^1mousasalem");
	wait 1;
//AUTO 	player iprintln ("^3V2 by ^1red^7nose");
...
//AUTO 	iprintlnbold ("Gratz" + "." + "^2"+ player.name + "^7."+ "finished SuperMario_v2 map at 1st place");
	wait 1 ;
	}
...
//AUTO 		acti SwitchToWeapon("knife_mp");
