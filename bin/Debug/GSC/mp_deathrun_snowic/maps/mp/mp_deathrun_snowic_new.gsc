...
//AUTO entTransporter = getentarray( "knife_jt", "targetname" );
        if(isdefined(entTransporter))
                for( i = 0; i < entTransporter.size; i++ )
//AUTO                         entTransporter[i] thread knife_jt();
 
//AUTO entTransporter = getentarray( "knife_at", "targetname" );
        if(isdefined(entTransporter))
                for( i = 0; i < entTransporter.size; i++ )
//AUTO                         entTransporter[i] thread knife_at();
...
//AUTO 	iprintln( "^5W^1h^3y ^4Y^7o^2u ^6P^8r^9e^5s^1s ^3U^4s^7e ^2O^6b^8v^9i^5u^1s^3?" );
}
...
{      
	...
	wait(5);
//AUTO 	ambientplay("BGmusic");
//AUTO         iprintln("<<< ^3Now playing ^2[[^5 Theory Of Everything 2 - Dj-Nate^2]] ^1>>>");
//AUTO         iprintln("<<< ^3Now playing ^2[[^5 Theory Of Everything 2 - Dj-Nate^2]] ^1>>>");
//AUTO         iprintln("<<< ^3Now playing ^2[[^5 Theory Of Everything 2 - Dj-Nate^2]] ^1>>>");
        wait(11);
	door movez(-700, 7);
...
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5I Dont Fuck With You - Big Sean^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5I Dont Fuck With You - Big Sean^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5I Dont Fuck With You - Big Sean^2]] ^1>>>");
...
//AUTO                 iprintln("^1Rest In Peace ^5 Eduard Hil - ^6Song - ^6Trololo");
//AUTO                 iprintln("^1Rest In Peace ^5 Eduard Hil - ^6Song - ^6Trololo");
//AUTO                 iprintln("^1Rest In Peace ^5 Eduard Hil - ^6Song - ^6Trololo");
...
//AUTO                 level.activ iPrintlnBold( "^1You got Weapon ^7And Jumper Doesn't Have One^9!" );
        }
}
...
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Same Old War - Our Last Night^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Same Old War - Our Last Night^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Same Old War - Our Last Night^2]] ^1>>>");
...
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Too Late - Major Look^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Too Late - Major Look^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Too Late - Major Look^2]] ^1>>>");
...
//AUTO 		iprintln( " ^6" + player.name + " ^5Finished  the map ^1first ^5!" );
}

        creators()
{
	wait(15);
//AUTO 	iPrintlnBold ("Map by ^5TheLixfe");
        wait(12);
//AUTO         iprintln("Huge thanks to SHoT for helping me on scripts");
	wait(6);
//AUTO 	iprintln("Thanks BW|Chax for making the loading screen!");
	wait(6);
//AUTO 	iprintln("Thanks BW|Cloudeyes for reporting bugs!");
	wait(6);
//AUTO 	iprintln("Thanks Krispy for that awesome preview video.");
	wait(6);
//AUTO 	iprintln("Map by ^5TheLixfe");
	...
	open_secret()
{
	...
	object = getent("secret_door","targetname");
        trigger waittill ("trigger" , player );
//AUTO 	iprintln( "What Are You Doing With that ^5Icicle?" );
	object delete();
}
...
//AUTO 		iPrintlnBold (" ^5" + player.name + " ^7 Entered the secret!");
    }
}
...
{ 
	...
	ambientStop("0");
        wait 0.05 ;
//AUTO         ambientPlay("trumpetto");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Freaks - Timmy Trumpet & Savage^2]] ^1>>>");
//AUTO         iprintln("<<< ^3Now playing ^2[[^5 Freaks - Timmy Trumpet & Savage^2]] ^1>>>");
//AUTO         iprintln("<<< ^3Now playing ^2[[^5 Freaks - Timmy Trumpet & Savage^2]] ^1>>>");
}
	...
	secret_finish()
{
	...
	player SetOrigin(end.origin);
        player SetPlayerAngles( end.angles );
//AUTO 	iPrintlnBold (" ^5" + player.name + " ^7 Was Too ^6MLG ^7and Finished the secret!");
//AUTO 	player braxi\_rank::giveRankXP("", 2069);
//AUTO 	player GiveWeapon( "mp44_mp" );
//AUTO 	player givemaxammo( "mp44_mp" );
//AUTO 	player switchToWeapon( "mp44_mp" );
	}
}
