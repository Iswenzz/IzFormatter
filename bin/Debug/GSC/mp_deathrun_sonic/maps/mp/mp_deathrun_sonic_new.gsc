...
text()
{
 for(;;)
 {
//AUTO   iprintln("^1>>>  Map made by ^5Calum  ^1<<<");
  wait 30;
//AUTO   iprintln("^1>>>  ^5#YOLO  ^1<<<");
  wait 30;
//AUTO   iprintln("^2Bumba, Jack<3");
  wait 120;
 }
}
...
//AUTO 	iprintlnbold("Player ^1"+player.name+" ^7entered snipe room!");
...
//AUTO 	iprintlnbold("Player ^1"+player.name+" ^7entered bounce room!");
...
//AUTO 	iprintlnbold("Player ^1"+player.name+" ^7entered weapons room!");
...
//AUTO 	iprintlnbold("Player ^1"+player.name+" ^7entered knife room!");
...
//AUTO 	other braxi\_rank::giveRankXp( "kill", 10 );
//AUTO 	other iprintln ("^3You got 10xp!");
