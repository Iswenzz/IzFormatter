...
//AUTO 		player iprintlnbold ("You have been teleportet to the ^2secret room");
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
	}
}
...
//AUTO 		player iprintlnbold ("^1You failed, try it again!");
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
	}
}
...
//AUTO 		player iprintlnbold ("^1You failed!");
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
	}
}
...
//AUTO 		player iprintlnbold ("^2You finished the secret room!");
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
