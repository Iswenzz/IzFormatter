...
trig delete();
{
self iprintln("^3Secret Step: ^71/4");
thread step2();
}
}
...
trig delete();
{
self iprintln("^3Secret Step: ^72/4");
thread step3();
}
}
...
trig delete();
{
self iprintln("^3Secret Step: ^73/4");
thread step4();
}
}
...
end()
{
  ...
  for(;;)
  {
     ...
     player iPrintlnBold( "^5Secret Prize: ^72000 ^5XP");
     iPrintlnBold( "^5" + player.name + " ^7has finished the secret room!!");
      }
}