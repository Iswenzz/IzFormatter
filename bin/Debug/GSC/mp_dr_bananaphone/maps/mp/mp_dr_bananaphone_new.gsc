...
//AUTO iPrintLnBold("The bananaphone got pwnd by ^1"+player.name+" ^7WOOT:D");
...
if(isDefined(knoptrigger)){
wait(2);
}
roep1 waittill ("trigger", player);
if(isDefined(sex1) && isDefined(sex2)){
wait(2);
}
...
//AUTO iPrintLnBold("WTF "+player.name+" WATCHING PORN PICURES!");
level.secret = true;
if(level.sex){
