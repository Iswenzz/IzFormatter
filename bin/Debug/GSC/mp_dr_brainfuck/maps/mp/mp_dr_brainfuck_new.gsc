...
//AUTO 	//////////////////////////////////////////Endrooms with Queue
//AUTO 	thread sniperlift_acti();
//AUTO 	thread sniperlift_jumper();
...
//AUTO 	thread RunRoomTrigger();
//AUTO 	thread TrampolinRoomTrigger();
//AUTO 	thread tankRoomTrigger();
//AUTO 	thread RandomWeapRoomTrigger();
	thread oldfight();
	
//AUTO 	///////////////Jumppad Tampoline Room////////////////
	wait 0.05;
	setupJumppads();
...
secret1() {
		...
		step1 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^31"); //Change the message if you want
		step2 waittill ("trigger", player);
		step2 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^32"); //Change the message if you want
		step3 waittill ("trigger", player);
		step3 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^33"); //Change the message if you want
		step4 waittill ("trigger", player);
		step4 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^34"); //Change the message if you want
		while(1) {
		step5 waittill ("trigger", player);	
//AUTO 			player iPrintLnBold("^3W^7elcome to the ^3S^7ecret^3!"); //Change the message if you want
...
//AUTO 		player iPrintLnBold("^3S^7tep^34"); //Change the message if you want
		step5 waittill ("trigger", player);	
		step5 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^35"); //Change the message if you want
		step6 waittill ("trigger", player);	
		step6 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^36"); //Change the message if you want
		step7 waittill ("trigger", player);	
		step7 delete();
//AUTO 		player iPrintLnBold("^3S^7tep^37"); //Change the message if you want
		while (1){
...
//AUTO 	AmbientPlay (getMusicSoundalias(ran) );
		wait 0.25;
}	
...
rpg_door_open() {
	...
	trigger waittill ("trigger", player);
	trigger delete();
//AUTO 	iprintlnbold ("Door opened^3!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the run room!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the trampolin room!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the tank room!");
...
starttime_jumper() {
	wait 2;
//AUTO 	self iprintlnbold("^3P^7repare yourself to run^3!");
	wait 1;
//AUTO 	self iprintlnbold("^13");
	wait 1;
//AUTO 	self iprintlnbold("^32");
	wait 1;
//AUTO 	self iprintlnbold("^21");
	wait 1;
//AUTO 	self iprintlnbold("^2RUUUUUUUN");
	self freezeControls(false);
}
...
starttime_acti() {
	wait 2;
//AUTO 	level.activ iprintlnbold("^3P^7repare yourself to run^3!");
	wait 1;
...
//AUTO 	level.activ iprintlnbold("^21");
	wait 1;
//AUTO 	level.activ iprintlnbold("^2RUUUUUUUN");
	level.activ freezeControls(false);
}
