...
{	
	...
	case 0:
	//****************Classic***************
//AUTO 		iprintlnbold("^5Classic Mode");
		
//AUTO 	 	ambientPlay("glass_ambient");
	...
	case 1:
	//****************Training**************
//AUTO 		iprintlnbold("^5Training Mode");
		
//AUTO         ambientPlay("train_ambient");		
	...
	case 2:
	//****************Fast******************
//AUTO 		iprintlnbold("^5Fast mode??");
		
//AUTO 		ambientPlay("fast_ambient");
	...
	case 3:
	//****************Long******************
//AUTO 		iprintlnbold("^5long Mode??");
		
//AUTO 		ambientPlay("long_ambient");
...
//AUTO 			ambientPlay("knife_ambient");
	}
}
...
//AUTO 			ambientPlay("desert_ambient");
	}
}
...
//AUTO 			ambientPlay("vipgun_ambient");
	}
}
...
//AUTO 	acti switchtoweapon(self.armo);
...
//AUTO 	jumper switchtoweapon(self.armo);
