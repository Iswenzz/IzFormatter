...
//AUTO 		p braxi\_rank::giveRankXP("", 600);
//AUTO 		iprintlnbold( p.name + " Finished the CJ Secret !");
...
gay() 
{
	...
	t waittill("trigger");
//AUTO 	iprintlnbold("Jax is ^6gay <3 ImJustBad");
}
...
lift()
{
	...
	wait 3;
//AUTO 	iprintlnbold("^1Start door opened :]");
	b moveZ(-300, 4);
	wait 4;
	b delete();
}
...
trig delete();
//AUTO user braxi\_rank::giveRankXP("", 150);
...
while(1)
	{
//AUTO 		iPrintLn("Map Made by ^1ImJustBad^7 & ^5SuX Lolz");
		wait 4;
//AUTO 		iPrintLn("^5RvS' ^7Deathrun");
		wait 4;
//AUTO 		iPrintLn("Check out our website rvs-gmaing.tk");
		wait 4;
//AUTO 		iPrintLn("youtube.com/exoticchris");
		wait 4;
...
//AUTO 		iprintln("^5Now Playing: ^7Cyber Posix - Sun Kissed");
	}
	if(random == 1)
	{
//AUTO 		AmbientPlay("music2");
//AUTO 		iprintln("^5Now Playing: ^7Liquid Memoirs - Lucid");
	}
	if(random == 2)
	{
//AUTO 		AmbientPlay("music3");
//AUTO 		iprintln("^5Now Playing: ^7Changing Faces ft. Charli Brix - Everything Is Gone (Basik Remix)");
	}
	if(random == 3)
	{
