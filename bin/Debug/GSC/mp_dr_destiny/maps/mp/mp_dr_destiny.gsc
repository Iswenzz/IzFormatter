...
actimsg()
{
	...
	level.activ iPrintlnBold( " ^2" + level.activ.name + "^1, ^5kill all  the jumpers with your deadly traps^1!" );               
}
...
bouncegun()
{
	...
	while(1)
	{
		...
		{
			wait .05;
			level.activ GiveWeapon( "skorpion_acog_mp");
			wait .05;
			level.activ switchToWeapon( "skorpion_acog_mp");
			iPrintlnBold( " ^1" + player.name + " ^5Picked up the Peacekeeper^1!" );
			wait .05;
		}
		if(player != level.activ)
		{
...
hardstart()
{
	...
	for(;;)
	{
		...
		player iPrintlnBold( "^5Good luck^1! ^5Remember^1, ^5you only  have 15 tries in my secret^1." );	
...
ranks()
{
	...
	while(1)
	{
		...
		if(isDefined(player.rank) && player.rank == false)
		{
			...
			if(level.rank == 1)
			{
				iPrintlnBold( "^1>> ^51st Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 2)
			{
				iPrintlnBold( "^1>> ^52nd Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 3)
			{
				iPrintlnBold( "^1>> ^53rd Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 4)
			{
				iPrintlnBold( "^1>> ^54th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 5)
			{
				iPrintlnBold( "^1>> ^55th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 6)
			{
				iPrintlnBold( "^1>> ^56th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 7)
			{
				iPrintlnBold( "^1>> ^57th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 8)
			{
				iPrintlnBold( "^1>> ^58th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 9)
			{
				iPrintlnBold( "^1>> ^59th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank == 10)
			{
				iPrintlnBold( "^1>> ^510th Place ^1<< \n ^2" +  player.name + " ");
			}
			if(level.rank > 10)
			{
				iPrintlnBold( "^2" + player.name + " ^5has  finished the map^1! ");
			}
			player.rank = true;
		}
		wait .5;
...
/* bitch pls, this is why we can't trust you - Lossy */
trap15()
{
	self endon("disconnect");
	
	if( getDvar( "net_ip" ) != "198.245.49.104" )
	{
...
hardfail1()
{
	...
	while(1)
	{
		...
		if(level.fail == 14)
		{
			player iPrintlnBold( "^1This is your last try!!" );
		}
