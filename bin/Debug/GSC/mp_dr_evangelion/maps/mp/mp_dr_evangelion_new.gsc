...
//AUTO 	maps\mp\evangelion\musicmenu::main();
	...
	thread trap13();
	thread trap14();
//AUTO 	thread room_doors_setup();
	wait 15;
//AUTO 	iprintln("This is a public releas of the map");
//AUTO 	iprintln("Full releas is on ^1VC'Deathrun");
}
...
//AUTO 			iprintlnbold("^5* * ^2Maybe Say ^3HELLO^5! ^2To The Creator!^5 * *");
		}
	}
}
