...
getweap(random){
	...
	switch (random){
//AUTO 	case 0: self takeallweapons();
//AUTO 			self giveWeapon("m21_mp", 100, 500 );
//AUTO 			self switchToWeapon("m21_mp"); 
			break;
//AUTO 	case 1: self takeallweapons();
//AUTO 			self giveWeapon("barrett_mp", 100, 500 );
//AUTO 			self switchToWeapon("barrett_mp"); 
			break;
//AUTO 	case 2: self takeallweapons();
//AUTO 			self giveWeapon("dragunov_mp", 100, 500 );
//AUTO 			self switchToWeapon("dragunov_mp"); 
			break;
//AUTO 	case 3: self takeallweapons();
//AUTO 			self giveWeapon("remington700_mp", 100, 500 );
...
//AUTO 	player iprintlnbold ("You made the first step");
	step1 delete();
	step2 waittill ("trigger", player);
//AUTO 	player iprintlnbold ("You made the second step");
	step2 delete();
	while (1){
	step3 waittill ("trigger", player);
//AUTO 	player iprintlnbold ("Welcome to the secret Room^1!");
	player setorigin (target.origin);
	player setplayerangles (target.angles);
...
exit() {
	...
	while(1){
		trigger waittill ("trigger", player);
//AUTO 		iPrintlnbold ("^1"+player.name + " ^7has finished the secret Room^1!");
		player notify("end_secret_timer");
//AUTO 		player iprintlnbold ("^1Your time limit is over yet you are not going to die anymore");
...
mapmusic() {
	...
	random = randomint (5);
	switch (random) {
//AUTO 		case 0: Ambientplay("fallrunsong1"); 
//AUTO 				iprintln("^7Now Playing^1:^7 Avicii  ^1- ^7You Make Me");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Avicii  ^1- ^7You Make Me");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Avicii  ^1- ^7You Make Me");
				break;
//AUTO 		case 1: Ambientplay("fallrunsong2");
//AUTO 				iprintln("^7Now Playing^1:^7 Draper ^1- ^7Night Rider");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Draper ^1- ^7Night Rider");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Draper ^1- ^7Night Rider");
				break;
//AUTO 		case 2: Ambientplay("fallrunsong3");
//AUTO 				iprintln("^7Now Playing^1:^7 Parov Stelar ^1- ^7Oh Yeah ");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Parov Stelar ^1- ^7Oh Yeah ");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Parov Stelar ^1- ^7Oh Yeah ");
				break;
//AUTO 		case 3: Ambientplay("fallrunsong4"); 
//AUTO 				iprintln("^7Now Playing^1:^7 M4SONIC  ^1- ^7Weapon ");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 M4SONIC  ^1- ^7Weapon ");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 M4SONIC  ^1- ^7Weapon ");
				break;
//AUTO 		case 4: Ambientplay("fallrunsong5");  
//AUTO 				iprintln("^7Now Playing^1:^7 Freestylers ^1- ^7Cracks");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Freestylers ^1- ^7Cracks");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Freestylers ^1- ^7Cracks");
