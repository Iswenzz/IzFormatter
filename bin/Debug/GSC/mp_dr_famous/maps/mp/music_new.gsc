...
//AUTO 	ambientPlay("wehz");
//AUTO 	iPrintlnBold( player.name + "^5Turned on ^0FAM^9OUS Wehz's Secret Song!");
...
//AUTO 	iPrintlnBold( player.name + "^5Turned on ^0FAM^9OUS NitroFire's Secret Song!");
...
//AUTO 	ambientPlay("voidix");
//AUTO 	iPrintLnBold( player.name + "^5Turned on ^6Voidix's ^5Boner Arising Song!");
...
//AUTO 	ambientPlay("liserd");
//AUTO 	iPrintLnBold( player.name + "^5Turned on ^0FAM^9OUS Liserd's Secret Song!");
