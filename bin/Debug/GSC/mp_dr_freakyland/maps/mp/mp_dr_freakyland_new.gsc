...
//AUTO     ambientPlay("sound");
	...
	thread teleportactitoend2();
        thread opendoor();
        thread olddoor();
//AUTO 		thread knifeend();
//AUTO 		thread sniperend();
...
{
	wait 10;	
//AUTO         iprintlnBold ("Map made by: FR3AK.");
        wait 8;
//AUTO         iprintlnBold ("Special thanks to: FearZ, F-3-A-R & Avenger");
        wait 8;
//AUTO         iprintlnBold ("^2xfire: ghost152");
        wait 8;
//AUTO         iprintlnBold ("Visit ^3up-clan.net");
}
...
for(;;)
    {
//AUTO         iprintln ("Map name mp_dr_freakyland.");
        wait 20;
//AUTO         iprintln ("Report ^1bugs ^7if you see it");
        wait 20;
//AUTO         iprintln ("Special thanks to: FearZ, F-3-A-R & Avenger");
		wait 20;
...
//AUTO 		iprintlnbold("" + " " + "^2"+ player.name + " "+ "^7has reached the secret!"); 
...
//AUTO 		iprintlnbold("" + " " + "^2"+ player.name + " "+ "^7Finished the secret and got a ^3deagle!"); 
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
...
//AUTO 		iprintlnbold("" + " " + "^2"+ player.name + " "+ "^7has reached the 2nd stage!"); 
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles ); 
    }  		
}
...
//AUTO 		iprintlnbold("" + " " + "^2"+ player.name + " "+ "^7has reached the final stage!"); 
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles ); 
    }  		
}
...
//AUTO iprintlnbold("^6Beginning door opening!"); 
door moveZ( -420, 7);
wait 9;
door delete();
}
...
//AUTO iprintlnbold("" + " " + "^2"+ player.name + " "+ "^7has chosen OLD!");
