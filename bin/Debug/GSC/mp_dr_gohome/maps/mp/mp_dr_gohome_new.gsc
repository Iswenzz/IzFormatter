...
actistart()
{
	...
	wait 0.1;
	obj movey(250, 1);
//AUTO 	who iprintlnbold ("^1Take no prisoners comrades!");
}
...
door()
{
	...
	obj movex(-240, 3);
	obj delete();
//AUTO 	self iprintln ("^1Take no prisoners comrades!");
}
...
/* AUTO 	trig waittill( "trigger", who ); 
	...
	trig delete();
	wait 0.1;
//AUTO 	iprintln ("^1Trap 9 ^2Activated");
	while(1)
	{
...
fake()  //Heh, ez meg�li a n00b jumpereket ^^
{
...
//AUTO 		Mrx iprintlnbold ("^1Victory is near!");
//AUTO 		wait 0.5 ;
		}
}
...
//AUTO     wait 1;
        ...
        {
//AUTO 		iprintlnbold("^1Free for ^2Uzi ^7!");
//AUTO 		iprintlnbold("^2Let's do this^7!");	
...
//AUTO     wait 1;
        ...
        {
//AUTO 		iprintlnbold("^1Sniper ^2Fighter ^7!");
//AUTO 		iprintlnbold("^2Let's do this^7!");	
...
//AUTO     wait 1;
        ...
        {
//AUTO 		iprintlnbold("^1Knife ^2time^7!");
//AUTO 		iprintlnbold("^2Let's do this^7!");	
...
//AUTO     wait 1;
        ...
        {
//AUTO 		iprintlnbold("^1Jumper ^2Master ^7!");
//AUTO 		iprintlnbold("^2Let's do this^7!");	
...
titok2()
{
	...
	for(i=0;i<players.size;i++)
		players[i] thread maps\mp\gametypes\_hud_message::notifyMessage( noti );
	wait 5;
//AUTO 	iprintlnbold("^2It's a TRAP, OMFG, ^1RUN RUN RUN^7!!");
	wait 3;
	obj delete();
	wait 1;
