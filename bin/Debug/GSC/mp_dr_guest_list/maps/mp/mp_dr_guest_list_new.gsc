...
{
wait 5;
//AUTO iprintlnBold("^1Map by Fish Da Rekter (BETA version)");
wait 1;
}
...
{
//AUTO ambientPlay("guest1");
//AUTO iPrintLn ("^0>> ^1Now playing: ^2 Maroon 5 - Animals ^0<<");
trig2 delete();
trig3 delete();
trig4 delete();
}
...
{
//AUTO ambientPlay("guest2");
//AUTO iPrintLn ("^0>> ^1Now playing: ^2 Nicky Romero vs Krewella - Legacy (Vicetone Remix) ^0<<");
trig1 delete();
trig3 delete();
trig4 delete();
}
...
{
//AUTO ambientPlay("guest3");
//AUTO iPrintLn ("^0>> ^1Now playing: ^2 Fedde Le Grand & Nicky Romero ft. Matthew Koma - Sparks (Vicetone Remix) ^0<<");
trig1 delete();
trig2 delete();
trig4 delete();
}
...
{
//AUTO ambientPlay("guest4");
//AUTO iPrintLn ("^0>> ^1Now playing: ^2 Alvaro & Jetfire - Guest List (Onderkoffer Remix) ^0<<");
trig1 delete();
trig2 delete();
trig3 delete();
}
...
//AUTO 			iPrintLnBold("^3" + player.name + "^5 chosen the old room");
...
//AUTO player giveMaxAmmo ("m40a3_mp");
//AUTO player switchToWeapon ("m40a3_mp");
//AUTO player iPrintLnBold ("^3 You got a sniper!");
}
