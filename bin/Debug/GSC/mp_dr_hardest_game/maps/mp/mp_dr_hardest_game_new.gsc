...
thread wave32();
thread tiptoefall1();
//AUTO thread tiptoegivesniper();
//AUTO thread main_music();
//AUTO thread finnish_music();
//AUTO thread sniper_music();
//AUTO thread knife_music();
//AUTO thread jump_music();
//AUTO thread race_music();
//AUTO thread tiptoe_music();
...
main_music()
{
     ...
     wait 1;
//AUTO 	 IPrintLn( "^1Now Playing ^3Worlds Hardest Game Theme" );
//AUTO      ambientPlay ("main"); 
}
...
//AUTO                 iPrintlnBold( " ^1" + player.name + "^4 Has Finished ^31st^1!" ); 
	 ambientstop(1);
	         
	         
//AUTO 	 IPrintLn( "^1Now Playing ^3Ludovico Einaudi - Experience (Starkey Remix)" );
//AUTO 	 ambientPlay ("finnish");
}
...
//AUTO 	 IPrintLn( "^1Now Playing ^3Sway - Still Speedin' [Instrumental]" );
...
//AUTO 	 IPrintLn( "^1Now Playing ^3Nick Ingman & Terry Devine-King - Mars (Heavy Rain: The Origami Killer OST)" );
...
//AUTO      IPrintLn( "^1Now Playing ^3Rihanna - Jump" );
...
//AUTO 	 IPrintLn( "^1Now Playing ^3Planet Perfecto - Bullet In The Gun" );  
//AUTO 	 ambientPlay ("race");
}
...
//AUTO 	 IPrintLn( "^1Now Playing ^3The Temper Trap - Sweet Disposition (Alto Remix) " );
//AUTO 	 ambientPlay ("tiptoe");
}
...
startgate()
{
  gate = getent("gate","targetname");
                             ...
                             {
                             wait(21);
//AUTO                              iprintlnbold("^4Good luck^1...");
                             gate movez (160,8);
...
teleport4()
{
 ...
 for(;;)
						 ...
						 trigger waittill ("trigger", player );
//AUTO 						 wait 0.05;
//AUTO                          iPrintlnBold( " ^4" + player.name + "^3 Has Found the ^5Secret!" );
...
//AUTO 						 iPrintlnBold( " ^4" + player.name + "^3 Has Finished the ^5Secret!" );
                         }
}
...
tiptoefall1() // cheers pixel for this one +1
{
	...
	{
//AUTO 		tiptoe_fall waittill("trigger", player ); //Trigger on the floor wait until the player has activated it
