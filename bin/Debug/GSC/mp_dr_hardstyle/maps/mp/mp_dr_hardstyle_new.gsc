...
//AUTO iprintlnbold("^2Start door is ^3opening^7");
...
wait(1);
//AUTO iprintln ("^2Thanks to ^1Wav3yMario");
wait(1);
//AUTO iprintln ("^2Thanks to ^1Ares|Opti");
wait(1);
//AUTO iprintln ("^2Thanks to ^1Ares|Galaxy");
}
...
wait 1;
//AUTO self iprintlnBold("^22");
wait 1;
//AUTO self iprintlnBold("^11");
wait 3;
//AUTO self iprintlnBold("^8FIGHT!");
...
secretenter()
{
        ...
        while(1)
        {
                        trig waittill("trigger", player);						
						wait 1.0;
//AUTO                         iprintlnbold( "^1 "+player.name+" ^3found secret!");			
        }
}
...
end()
{
	...
	trig waittill("trigger",player);	
	{
//AUTO 	iPrintLnBold("^5"+player.name+" "+"^6"+"reached the end first!");
}
}	
