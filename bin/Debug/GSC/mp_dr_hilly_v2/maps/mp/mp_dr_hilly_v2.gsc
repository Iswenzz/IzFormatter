...
trap1()
{
	...
	door2 moveZ (-120,0.1);
	wait 1;
	iprintLnBold("How do you think you're going to die?");
	wait 3;
	iprintLnBold("The first person to guess right survives. You have 5 seconds.");
	wait 5;
	iprintLnBold("I lied. You're all dead inside trap1.");
	wait 1;
	brush moveZ (-500,1);
	wait 1;
	door1 delete();
