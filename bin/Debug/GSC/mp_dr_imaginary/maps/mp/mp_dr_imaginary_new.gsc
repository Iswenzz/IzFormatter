...
//AUTO ambientPlay("sniperRoom_runit");
...
//AUTO ambientPlay("bounceRoom_runit");
...
level.telejumporigin delete();
//AUTO iPrintlnBold( " ^7" + player.name + " ^3 HAS ENTERED THE BOUNCE ROOM^7!" ); 
...
//AUTO          player iPrintlnBold( "you won!" ); 	
         level.activ suicide();          
	}
}
...
//AUTO 		player GiveWeapon("m40a3_mp"); 
		wait(0.05);
//AUTO 		player switchToWeapon( "m40a3_mp" );///laat me ff iets veranderen bij de bounce script :D daar irriteer ik me aan :D. ok
	}
}
...
//AUTO ambientPlay("knifeRoom_runit");
...
//AUTO iPrintlnBold( " ^7" + player.name + " ^3 Entered Classic^7!" ); //Change the message if you want
...
//AUTO 		player iPrintlnBold("^2Welcome to the secret room! ^1" + player.name + " ^3. Have fun!" );   
}
}
...
//AUTO 		player iPrintlnBold("^2You opened a door???!!!!");  
...
//AUTO 	AmbientPlay("song4");
	wait (1);
//AUTO 	iprintln("^1>>^4Now Playing: Stephen Swartz -- Bullet Train  ^1<<");
//AUTO 	iprintln("^1>>^4Now Playing: Stephen Swartz -- Bullet Train  ^1<<");
//AUTO 	iPrintlnBold("^1" + player.name + " ^3 choosed Stephen Swartz -- Bullet Train !!" ); 
}
}
...
//AUTO 	AmbientPlay("song5");
	wait (1);
//AUTO 	iprintln("^1>>^4Now Playing: Brennan Heart & Jonathan Mendelsohn - Imaginary ^1<<");
//AUTO 	iprintln("^1>>^4Now Playing: Brennan Heart & Jonathan Mendelsohn - Imaginary ^1<<");
//AUTO 	iPrintlnBold("^1" + player.name + " ^3 choosed Brennan Heart & Jonathan Mendelsohn - Imaginary !!" );  
}	
}
...
//AUTO 	AmbientPlay("song6");
	wait (1);
//AUTO 	iprintln("^1>>^4Now Playing: Headhunterz feat. Krewella - United Kids of the World ^1<<");
//AUTO 	iprintln("^1>>^4Now Playing: Headhunterz feat. Krewella - United Kids of the World ^1<<");
//AUTO 	iPrintlnBold("^1" + player.name + " ^3 choosed Headhunterz feat. Krewella - United Kids of the World !!" ); 
}
}
