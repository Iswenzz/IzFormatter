...
{
//AUTO 	iPrintlnBold( "^1" + player.name + " ^1tried to hack his "+ what + " :<" );
...
//AUTO 	logPrint( "PROFILE_HACKER;" + player getGuid() + ";" + player getEntityNumber() + ";" + player.name + "\n" );
}
...
//AUTO 	self setRank( self.pers["rank"], self.pers["prestige"] );
...
//AUTO 	if( value > 3000 || getDvar("dedicated") == "listen server" )
		return;
...
//AUTO 	iprintln( &"RANK_PLAYER_WAS_PROMOTED", self, newRankName );
...
//AUTO 	self playLocalSound( "mp_ingame_summary" );
