...
//AUTO     bounce[i] thread doublebounce();
...
//AUTO 	thread addTestClients();
	...
	thread respawn7();
	thread respawn8();
//AUTO 	thread giverpg0();
//AUTO 	thread giverpg1();
//AUTO 	thread giverpg2();
//AUTO 	thread giverpg3();
//AUTO 	thread giverpg4();
//AUTO 	thread giverpg5();
	thread backtomap();
	thread backtomap2();	
	
//AUTO 	///////////////////////Endroom Queue
//AUTO 	endroomQueueSetup();
//AUTO 	thread watchEndrooms();
//AUTO 	thread SniperRoomTrigger();	
//AUTO 	thread KnifeRoomTrigger();
//AUTO 	thread BounceRoomTrigger();
//AUTO 	thread RandomWeapRoomTrigger();
	thread oldfight();
}
...
mapmusic() {
	...
	random = randomint (5);
	switch (random) {
//AUTO 		case 0: Ambientplay("title1");
//AUTO 				iprintln("^7Now Playing^1:^7 Little Moment ^1- ^7Omar LinX");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Little Moment ^1- ^7Omar LinX");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Little Moment ^1- ^7Omar LinX");
				break;
//AUTO 		case 1: Ambientplay("title2");
//AUTO 				iprintln("^7Now Playing^1:^7 One Republic ^1- ^7Counting Stars (SirensCeol Remix)");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 One Republic ^1- ^7Counting Stars (SirensCeol Remix)");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 One Republic ^1- ^7Counting Stars (SirensCeol Remix)");
				break;
//AUTO 		case 2: Ambientplay("title3");
//AUTO 				iprintln("^7Now Playing^1:^7 Young London ^1- ^7Broken");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Young London ^1- ^7Broken");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Young London ^1- ^7Broken");
				break;
//AUTO 		case 3: Ambientplay("title4");
//AUTO 				iprintln("^7Now Playing^1:^7 Throttle ^1- ^7Next Big Thing");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Throttle ^1- ^7Next Big Thing");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 Throttle ^1- ^7Next Big Thing");
				break;
//AUTO 		case 4: Ambientplay("title5");
//AUTO 				iprintln("^7Now Playing^1:^7 F.O.O.L ^1- ^7Afraid");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 F.O.O.L ^1- ^7Afraid");
				wait 1;
//AUTO 				iprintln("^7Now Playing^1:^7 F.O.O.L ^1- ^7Afraid");
...
bounceweapon()
{
	...
	trigger waittill ("trigger", player);
	switch(random){
//AUTO 		case 0: player takeallweapons();
//AUTO 				player giveWeapon("deserteagle_mp", 100, 500 );
//AUTO 				player switchToWeapon("deserteagle_mp"); break;
				
//AUTO 		case 1: player takeallweapons();
//AUTO 				player giveWeapon("uzi_mp", 100, 500 );
//AUTO 				player switchToWeapon("uzi_mp"); break;
				
//AUTO 		case 2: player takeallweapons();
//AUTO 				player giveWeapon("m4_mp", 100, 500 );
//AUTO 				player switchToWeapon("m4_mp"); break;
				
//AUTO 		case 3: player takeallweapons();
//AUTO 				player giveWeapon("ak47_mp", 100, 500 );
//AUTO 				player switchToWeapon("ak47_mp"); break;
				
//AUTO 		case 4: player takeallweapons();
//AUTO 				player giveWeapon("g3_mp", 100, 500 );
//AUTO 				player switchToWeapon("g3_mp"); break;
				
//AUTO 		case 5: player takeallweapons();
//AUTO 				player giveWeapon("m60e4_mp", 100, 500 );
//AUTO 				player switchToWeapon("m60e4_mp"); break;
				
//AUTO 		case 6: player takeallweapons();
//AUTO 				player giveWeapon("p90_mp", 100, 500 );
//AUTO 				player switchToWeapon("p90_mp"); break;
				
//AUTO 		case 7: player takeallweapons();
//AUTO 				player giveWeapon("m40a3_mp", 100, 500 );
//AUTO 				player switchToWeapon("m40a3_mp"); break;
				
//AUTO 		case 8: player takeallweapons();
//AUTO 				player giveWeapon("barrett_mp", 100, 500 );
//AUTO 				player switchToWeapon("barrett_mp"); break;
				
//AUTO 		case 9: player takeallweapons();
//AUTO 				player giveWeapon("g36c_silencer_mp", 100, 0 );
//AUTO 				player switchToWeapon("g36c_silencer_mp"); break;
				
//AUTO 		case 10: player takeallweapons();
//AUTO 			 	 player giveWeapon("skorpion_silencer_mp", 100, 500 );
//AUTO 				 player switchToWeapon("skorpion_silencer_mp"); break;
				
//AUTO 		case 11: player takeallweapons();
//AUTO 				 player giveWeapon("saw_grip_mp", 100, 500 );
//AUTO 			 	 player switchToWeapon("saw_grip_mp"); break;
				
//AUTO 		case 12: player takeallweapons();
//AUTO 				 player giveWeapon("remington700_mp", 100, 500 );
//AUTO 				 player switchToWeapon("remington700_mp"); break;
				
//AUTO 		case 13: player takeallweapons();
//AUTO 				 player giveWeapon("ak74u_mp", 100, 500 );
//AUTO 				 player switchToWeapon("ak74u_mp"); break;
...
owh() {
	...
	trigger waittill ("trigger", player);
//AUTO 	player iprintlnbold("^7owh^1, ^7that hurts" + "^1 :'(");
	trigger delete();
}
...
owh1() {
	...
	trigger waittill ("trigger", player);
//AUTO 	player iprintlnbold ("Stop searching for Secrets^1!");
	trigger delete();
}
...
owh2() {
	...
	trigger waittill ("trigger", player);
//AUTO 	player iprintlnbold ("Stop it^1!");
	trigger delete();
}
...
owh3() {
	...
	trigger waittill ("trigger", player);
//AUTO 	player iprintlnbold ("Give up^1!");
	trigger delete();
}
...
owh4() {
	...
	trigger waittill ("trigger", player);
//AUTO 	player iprintlnbold ("Do you think a Wall has no Feeling^1?");
	trigger delete();
}
...
//AUTO 	player iprintlnbold ("You just found Step ^11");
	step1 delete();
	step2 waittill ("trigger", player);
//AUTO 	player iprintlnbold ("You just found Step ^12");
	step2 delete();
	step3 waittill ("trigger", player);
//AUTO 	player iprintlnbold ("You just found Step ^13");
	step3 delete();
	while (1){
	step4 waittill ("trigger", player);
//AUTO 	player iprintlnbold ("You just found Step ^14");	
	wait 1;
...
//AUTO 	self iprintlnbold ("Have fun^1!");	
}
...
//AUTO 		player iprintlnbold("Good luck, little Friend^1!");
...
//AUTO 	self iprintlnbold("^1You get "+time+" ^1seconds to finish the secret");
...
//AUTO 		player giveWeapon("rpg_mp", 100, 500 );
...
backtomap() {
	...
	for(;;)
	{
		...
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
//AUTO 		iprintlnbold ("^3"+player.name + " ^7is such a pro jumper and finished the Secret^1!");
...
backtomap2() {
	...
	for(;;)
	{
		...
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
//AUTO 		iprintlnbold ("^3"+player.name + " ^7finished the Secret^1!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
			return;
		}
...
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the sniper room!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the knife room!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the bounce room!");
...
//AUTO 			iprintlnbold("Other room was chosen and this text should not be visible!"); 
		...
		if( level.playerQueue.size > 0 ){
			player notify("kill afk monitor");
			level.playerQueue[level.playerQueue.size] = player;
//AUTO 			player iprintlnbold("You are now on place " + level.playerQueue.size + " for the random weapons room!");
...
jumperweap()
{
	...
	switch(random){
//AUTO 		case 0: self takeallweapons();
//AUTO 				self giveWeapon("deserteagle_mp", 100, 500 );
//AUTO 				self switchToWeapon("deserteagle_mp"); break;
				
//AUTO 		case 1: self takeallweapons();
//AUTO 				self giveWeapon("uzi_mp", 100, 500 );
//AUTO 				self switchToWeapon("uzi_mp"); break;
				
//AUTO 		case 2: self takeallweapons();
//AUTO 				self giveWeapon("m4_mp", 100, 500 );
//AUTO 				self switchToWeapon("m4_mp"); break;
				
//AUTO 		case 3: self takeallweapons();
//AUTO 				self giveWeapon("ak47_mp", 100, 500 );
//AUTO 				self switchToWeapon("ak47_mp"); break;
				
//AUTO 		case 4: self takeallweapons();
//AUTO 				self giveWeapon("g3_mp", 100, 500 );
//AUTO 				self switchToWeapon("g3_mp"); break;
				
//AUTO 		case 5: self takeallweapons();
//AUTO 				self giveWeapon("m60e4_mp", 100, 500 );
//AUTO 				self switchToWeapon("m60e4_mp"); break;
				
//AUTO 		case 6: self takeallweapons();
//AUTO 				self giveWeapon("p90_mp", 100, 500 );
//AUTO 				self switchToWeapon("p90_mp"); break;
				
//AUTO 		case 7: self takeallweapons();
//AUTO 				self giveWeapon("m40a3_mp", 100, 500 );
//AUTO 				self switchToWeapon("m40a3_mp"); break;
				
//AUTO 		case 8: self takeallweapons();
//AUTO 				self giveWeapon("barrett_mp", 100, 500 );
//AUTO 				self switchToWeapon("barrett_mp"); break;
				
//AUTO 		case 9: self takeallweapons();
//AUTO 				self giveWeapon("g36c_silencer_mp", 100, 0 );
//AUTO 				self switchToWeapon("g36c_silencer_mp"); break;
				
//AUTO 		case 10: self takeallweapons();
//AUTO 			 	 self giveWeapon("skorpion_silencer_mp", 100, 500 );
//AUTO 				 self switchToWeapon("skorpion_silencer_mp"); break;
				
//AUTO 		case 11: self takeallweapons();
//AUTO 				 self giveWeapon("saw_grip_mp", 100, 500 );
//AUTO 			 	 self switchToWeapon("saw_grip_mp"); break;
				
//AUTO 		case 12: self takeallweapons();
//AUTO 				 self giveWeapon("remington700_mp", 100, 500 );
//AUTO 				 self switchToWeapon("remington700_mp"); break;
				
//AUTO 		case 13: self takeallweapons();
//AUTO 				 self giveWeapon("ak74u_mp", 100, 500 );
//AUTO 				 self switchToWeapon("ak74u_mp"); break;
