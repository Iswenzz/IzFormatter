...
//AUTO 	//ambientPlay("ambient_backlot");
	game["allies"] = "sas";
	game["axis"] = "opfor";
	game["attackers"] = "axis";
	...
	thread elevator2();
	thread old_battle();
//AUTO 	thread sniper_battle();
//AUTO 	thread shotgun_battle();
//AUTO 	thread knife_battle();
	thread old_clip();
	thread jump_trig();
//AUTO 	thread check_knife();
//AUTO 	thread check_sniper();
//AUTO 	thread check_shotgun();
	thread check_old();
	thread secret();
	thread secret_tip();
//AUTO 	thread secretweapon();
	thread death();
	thread check_pistol();
...
messages()
{
        ...
        {
		wait 20;
//AUTO         iprintln ("^2Map created by ^3[BSF]Punk");
        wait 10;
//AUTO         iprintln ("^2Exclusively made for ^3LukServers");
        wait 10;
...
//AUTO iprintlnbold("^3Beginning door is opening...");
wait 2;
door moveZ (448,0.5);
...
//AUTO iprintlnbold("^2" + user.name +" ^3activated the elevator");
wait 2;
door delete();
wait 2;
...
//AUTO iprintlnbold("^2" + who.name +" ^3found the secret room and got a machine gun o.o");
}
...
trig waittill("trigger", user);
wait 0.01;
//AUTO user GiveWeapon("saw_reflex_mp");
wait 0.001;
//AUTO user SwitchToWeapon("saw_reflex_mp");
wait 0.01;
...
//AUTO iprintlnbold("^2" + user.name +" ^3activated the second elevator");
...
brush delete();
//AUTO iprintlnbold("^2" + user.name +" ^3entered the second floor");
}
...
brush waittill("movedone");
brush delete();
//AUTO iprintlnbold("^2" + user.name +" ^3 entered the final level");
}
...
trig waittill("trigger", user);
trig delete();
//AUTO iprintlnbold("^2Seems like activator ^3barricaded this door");
wait 2;
//AUTO iprintlnbold("^3Use this rpg to ^2blow that door ^1but don't switch weapon");
...
door waittill("movedone");
door delete();
//AUTO iprintlnbold("^2" + user.name +"^3 choose the old way");
}
...
trig delete();
old delete();
//AUTO iprintln("^2Old way ^3is ^1closed");
}
...
trig delete();
sniper delete();
//AUTO iprintln("^2Sniper room ^3is ^1closed");
}
...
trig delete();
shotgun delete();
//AUTO iprintln("^2Shotgun room ^3is ^1closed");
}
...
trig delete();
knife delete();
//AUTO iprintln("^2Knife room ^3is ^1closed");
}
...
//AUTO iprintlnbold("^2" + jumper.name + " ^3entered the shotgun room");
...
//AUTO iprintlnbold("^2" + jumper.name + " ^3entered the knife room");
...
//AUTO 		iprintlnbold("^2" + jumper.name +" ^3entered the sniper room");
...
//AUTO 		iprintlnbold("^3" + jumper.name + " ^1died");
...
//AUTO iprintlnbold("^2" + jumper.name + " ^3has entered the pistol room");

//AUTO jumper TakeAllWeapons();
//AUTO jumper GiveWeapon("deserteaglegold_mp");
//AUTO jumper GiveMaxAmmo("deserteaglegold_mp");
//AUTO wait 0.01;
//AUTO jumper SwitchToWeapon("deserteaglegold_mp");
...
trig delete();
pistol delete();
//AUTO iprintln("^2Pistol room ^3is ^1closed");
}
