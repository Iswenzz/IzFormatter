...
//AUTO  thread teleportbouncejumper();
//AUTO  thread teleportbounceactivator();
...
{
wait 10;
//AUTO iprintlnBold("^8L^0X^8U^0R^2Y!!");
wait 3;
//AUTO iprintlnBold("^8>>^0Map by ^1L^2o^3o^4t^5j^6e^8<<");
wait 4;
//AUTO iprintln("^8My frist map plees be kind");
//AUTO iprintln("^8My frist map plees be kind");
wait 1;
}
...
teleport2()
{
	...
	for(;;)
	{
		...
		player setPlayerAngles(target.angles);
		player setOrigin(target.origin);
//AUTO 		player iprintln("^1Aaaaand youre back!");
	}
}
...
teleportsecret()
{
	...
	for(;;)
	{
		...
		player setPlayerAngles(target.angles);
		player setOrigin(target.origin);
//AUTO 		iPrintlnBold( player.name + "^8 Has entered the ^3secret!" );
	}
}
...
teleportsecretfail()
{
	...
	for(;;)
	{
		...
		player setPlayerAngles(target.angles);
		player setOrigin(target.origin);
//AUTO 		player iprintln("^8Lez try dat again shall we");
	}
}
...
teleportsecretend()
{
	...
	for(;;)
	{
		...
		player setPlayerAngles(target.angles);
		player setOrigin(target.origin);
//AUTO 		iPrintlnBold( player.name + "^8 Has finished da ^3secret!" );
//AUTO 		player GiveWeapon("m40a3_mp");
//AUTO 		player GiveMaxAmmo("m40a3_mp");
//AUTO 		wait .05;
//AUTO 		player SwitchToWeapon("m40a3_mp");  
//AUTO 		player iPrintlnBold("^8Here have a sniper");
	}
}
...
music SetHintString("^4Press ^7use ^4to ^7play ^4music");
{
	...
	if(possibility == 1)
	{
//AUTO 		ambientplay( "jaws" );
//AUTO 		iprintln("^4Song: ^9Lxury - J.A.W.S");
//AUTO 		iprintln("^4Song: ^9Lxury - J.A.W.S");
//AUTO 		iprintln("^4Song: ^9Lxury - J.A.W.S");
	}
	...
	{
//AUTO 		ambientPlay("company");
//AUTO 		iprintln("^4Song: ^9Lxury - Company");
//AUTO 		iprintln("^4Song: ^9Lxury - Company");
//AUTO 		iprintln("^4Song: ^9Lxury - Company");
	}
	...
	{
//AUTO 		ambientPlay("benediction");
//AUTO 		iprintln("^4Song: ^9Hot Natured - Benediction (Lxury remix)");
//AUTO 		iprintln("^4Song: ^9Hot Natured - Benediction (Lxury remix)");
//AUTO 		iprintln("^4Song: ^9Hot Natured - Benediction (Lxury remix)");
	}
...
music delete();
//AUTO iprintlnbold(" ^8 Someone here is a ^3luxurious DJ^8!");
wait 1;
}
}
