...
//AUTO 	thread actipickroom1();
//AUTO 	thread actipickroom2();
//AUTO 	thread actipickroom3();
//AUTO 	thread actipickroom4();
//AUTO 	//thread musictrig();
	thread text();
	thread mewen_text();
//AUTO 	thread mapmusic();
	thread special();
//AUTO 	//thread specialmenu();
	//thread failstart();
	thread easytp();
	thread which_quest();
	//thread secretmain1();
	thread hardtp();
	thread hardfinish();
//AUTO 	thread easybouncer();
//AUTO 	thread hardbouncer();
//AUTO 	thread hardbouncer2();
	thread hardsecretjump();
//AUTO 	thread secretbouncer();
	thread secretxp();
	thread secretswitch();
//AUTO 	thread vipexit();
//AUTO 	thread vipsongs();
//AUTO 	thread specialmenu();
//AUTO 	thread vipfeatures();
    thread easydodge();
...
//AUTO      thread room_sniper();
//AUTO   	 thread sniperbounce();
//AUTO      thread room_knife();
//AUTO      thread room_bulldog();
...
//AUTO 	thread acti_roomexplain_ss();
//AUTO 	thread acti_roomexplain_bulldog();
//AUTO 	thread jumper_roomexplain_ss();
//AUTO 	thread jumper_roomexplain_bulldog();
...
//AUTO     arrow1 = getent("roomarrow1", "targetname");
//AUTO 	arrow2 = getent("roomarrow2", "targetname");
//AUTO 	arrow3 = getent("roomarrow3", "targetname");
//AUTO 	arrow4 = getent("roomarrow4", "targetname");
	arrow1 hide();
	arrow2 hide();
	arrow3 hide();
	arrow4 hide();
...
mapmusic()
{
	...
	//songs2 = randomint(2)
	switch (songs) {
//AUTO 		case 0: Ambientplay("song1");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Logic ^1- ^7Till The End");
			break;
		}
//AUTO 		case 1: Ambientplay("song2");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Wretch 32 ^1- ^7Fire in the booth radio 1 extra");
			break;
		}
//AUTO 		case 2: Ambientplay("song3");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Yungen ^1- ^7You Don't Know Me Like That");
			break;
		}
//AUTO 		case 3: Ambientplay("song4");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Wiley ^1- ^7Bring Them All/Holy Grime");
			break;
		}
//AUTO 		case 4: Ambientplay("song5");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Logic ^1- ^7Man Of The Year");
			break;
		}
//AUTO 		case 5: Ambientplay("song6");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Mac Miller ^1- ^7Donald Trump");
			break;
		}
//AUTO 		case 6: Ambientplay("song7");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("e-dubble ^1- ^7Be A King");
			wait 1;
//AUTO 			iprintln("^5R.I.P e-dubble :(");
			break;
		}
//AUTO 		case 7: Ambientplay("song8");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("e-dubble ^1- ^7Let Me Oh");
			wait 1;
//AUTO 			iprintln("^5R.I.P e-dubble :(");
			break;
		}
//AUTO 		case 8: AmbientPlay("song9");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Logic ^1- ^7Fade Away");
			break;
		}
	}
}
...
mewen_text()
{
	...
	wait 7;
//AUTO 	iprintLnBold("^5>> ^1M^7ap ^1B^7y ^1Mewen^5 <<");
	for(;;)
	{
		text hide();
		text2 show();
		wait 3;
//AUTO 		//self playLocalSound("scarce");
		text2 hide();
		text show();
		wait 3;
	}
...
//AUTO 	iprintLnBold("^1Activator ^2Wants The Room ^1>> ^7[^6Sniper^7]");
...
//AUTO 	iprintLnBold("^1Activator ^2Wants The Room ^1>> ^7[^6Knife^7]");
...
//AUTO 	iprintLnBold("^1Activator ^2Wants The Room ^1>> ^7[^6Simon Says^7]");
...
//AUTO 	iprintLnBold("^1Activator ^2Wants The Room ^1>> ^7[^6Bulldog^7]");
...
for(;;)
{
	...
	{
//AUTO 		player iprintlnbold("You're too late for a room explanation soz");
		trig delete();
//AUTO 		wait 1;
...
//AUTO 		player iprintlnbold("You're too late for a room explanation soz");
	...
	player setOrigin(tp.origin);
	player setPlayerAngles(tp.angles);
//AUTO 	player iprintlnbold("^1>> ^7In this room you'll start as a bulldog ^1<<");
	wait 3.5;
//AUTO 	player iprintlnbold("^1>> ^7As a Bulldog, you must knife the jumper as he tries to run past you ^1<<");
	wait 3.5;
//AUTO 	player iprintlnbold("^1>> ^7Knife the runner whilst staying in your area marked by the red line ^1<<");
	wait 4.5;
	...
	player freezeControls(0);
	wait 3.5;
//AUTO 	player iprintlnbold("^1>> ^7If the runner gets past you, the roles will swap ^1<<");
	wait 4;
	player unlink();
	player setOrigin(passtime.origin);
	player setPlayerangles(passtime.angles);
...
ohdear()
{
	...
	for(;;)
	{
		...
		{
			if(player.fails == 3)
//AUTO 				player iprintlnbold("^1Cmon you're not even in the actual map yet");
			player.fails++;
			player setorigin(tp.origin);
		}
		...
		else if(player.fails == 4)
		{
			//Special needs
			player.fails = 0;
//AUTO 			player iprintlnbold("Okay. ^1Let Me Help You Out");
			time = 1;
//AUTO 			wait 0.5;
			air = spawn ("script_model",(0,0,0));
			air.origin = player.origin;
			air.angles = player.angles;
			player linkto (air);
//AUTO 			//user sayAll("^1LOL ^7I Couldn't Even Get Into The Actual ^1Map");
...
secret2()
{
	...
	{
		trig waittill("trigger", player);
//AUTO 		//iprintlnbold("^1"+player.name+" ^7Entered Secret: ^12");
		player setOrigin(tp.origin);
		player setplayerangles(tp.angles);
	}
}
...
secret2_fail()
{
	...
	{
		trig waittill("trigger", player);
//AUTO 		player iprintlnbold("^1You got hurt a little for failing");
		player setOrigin(tp.origin);
		player setplayerangles(tp.angles);
...
//AUTO 		wait 0.3;
		player setOrigin(tp.origin);
//AUTO 		iprintlnbold("^1"+player.name+" ^7Finished The ^1Second ^7Secret");
...
hardsecret_tp()
{
	...
	for(;;)
	{
		...
		player setOrigin(tp.origin);
		player setPlayerAngles(tp.angles);
//AUTO 		player iprintlnbold("^0G^7oodluck");
	}
}
...
hardmove2()
{
	...
	for(;;)
	{
		trig waittill ("trigger",user);
		wait 0.5;
//AUTO 		iprintlnbold("^7Nice Shortcut, Here's some ^1XP");
		//throw = user.origin + (100, 100, 0);
		air = spawn ("script_model",(0,0,0));
		air.origin = user.origin;
		air.angles = user.angles;
...
//AUTO 		wait 0.5;
		player setOrigin(tp.origin);
		player setplayerangles(tp.angles);
//AUTO 		player iprintlnbold("^1Woah nice one. ^7Take this XP and I'll put you somewhere cool :)");
...
//AUTO 				player iprintlnbold("^1Welcome to the secret!");
			}
			else
			{
...
ezsecrettp()
{
	...
	{
		trig waittill("trigger", player);
//AUTO 		player iprintlnbold("^1Welcome. ^7You can die here^1, watch it ^1;)");
		player setOrigin(tp.origin);
		player setplayerangles(tp.angles);
	}
}
...
//AUTO 		wait 0.5;
		player setOrigin(tp.origin);
		player setplayerangles(tp.angles);
//AUTO 		iprintlnbold("^1"+player.name+" ^7Finished the ^1First ^7Secret");
	}
}
...
actisecret()
{
	...
	for(;;)
	{
		...
		player setOrigin(tp.origin);
		player setPlayerangles(tp.angles);
//AUTO 		//iprintlnbold("^1Activator ^7Entered a ^1Secret");
	}
}
...
actisecretend()
{
	...
	{
		trig waittill("trigger", player);
//AUTO 		player iprintlnbold("^1You Completed the Activator Jumps");
		player setOrigin(tp.origin);
...
endmapfirst()
{
	...
	trig waittill("trigger", player);
//AUTO 	iPrintlnBold("^2"+player.name+" ^7Finished ^5First^3!");
	trig delete();
...
//AUTO 		wait 0.3;
		player setOrigin(tp.origin);
//AUTO 		iprintlnbold("^1"+player.name+" ^7Finished ^1Hard");
	}
}
...
//AUTO 	iprintln("^1"+ player.name + " ^7Finished The Map");
	level.mapfinished = 1;
	wait .1;
}
...
Endrooms() 
{
	...
	player setPlayerAngles(tp.angles);
	player setOrigin(tp.origin);
//AUTO 	iPrintLnBold( " ^1" + player.name + " ^7Is picking a room." );
...
//AUTO 	iPrintlnBold("^6"+level.playername+"^2 Lost to ^1"+level.activ.name);

		if(!isdefined(level.activKills))
			level.activKills = 0;

			level.activKills += 1;
//AUTO 		iPrintlnBold("^1>>Activator<< ^2Is on a killstreak of: ^1"+level.activKills+"^6!");
		thread killstreak();
		wait 1;
//AUTO 	iPrintLnBold("^6Selection Room ^7is now ^7open^6!"); 
}
...
//AUTO 		ambientPlay("song13");

		player freezeControls(1);
		level.activ freezeControls(1);
			
//AUTO 		iPrintlnBold("^2"+ player.name + " ^7Challenges ^1"+level.activ.name+" ^7To A Game Of ^1Simon Says^7!");
...
//AUTO 		player iprintlnbold("^1You ^7lost to the ^1Activator");

//AUTO 		level.activ giveWeapon("deserteagle_mp");
//AUTO 		level.activ switchToWeapon("deserteagle_mp");
//AUTO 		level.activ iprintlnbold("^1You Win! ^7now kill the ^1Jumper");
		wait 2.5;
		level.activ freezeControls(0);
	} 
	else
...
//AUTO 		level.activ iprintlnbold("^1You ^7lost to the ^1Jumper");

//AUTO 		player giveWeapon("deserteagle_mp");
//AUTO 		player switchToWeapon("deserteagle_mp");
//AUTO 		player iprintlnbold("^1You Win! ^7now kill the ^1Activator");
		wait 2.5;
		player freezeControls(0);
	}
}
...
ss_game(player)
{
	...
	while (level.ss_on == 1)
	{
		...
		{
//AUTO 			player iprintlnbold("^1You've been given a knife as game went on too long");
//AUTO 			level.activ iprintlnbold("^1You've been given a knife as game went on too long");
...
//AUTO 		iPrintlnBold(" ^2"+ player.name + " ^7Challenges ^1"+level.activ.name+ " ^7To A ^1Sniper ^7Fight");
...
//AUTO 		iPrintlnBold("^2"+ player.name + " ^7Challenges ^1"+level.activ.name+" ^7To A ^1Knife ^7Fight!");
...
//AUTO 		ambientPlay("song10");
		wait 0.5;

		level.trig1 = getent("bulldog_escape", "targetname");
		level.trig2 = getent("bulldog_box", "targetname");
//AUTO 		iPrintlnBold("^2"+ player.name + " ^7Challenges ^1"+level.activ.name+" ^7To a game of ^1Bulldog");
...
//AUTO 		player iprintlnbold("^1Room unavailable. ^7Pick another");
	}
...
//AUTO 	player iprintlnbold("You Are The ^1Runner");
//AUTO 	level.activ iprintlnbold("You Are The ^1BullDog");
	wait 1;
	level.activ freezeControls(0);
	thread runner_status(player);
	thread attacker_status(player);
//AUTO 	//player iprintlnbold("^1Run ^7Past The ^1Bulldog ^7To The ^1Other Side");
//AUTO 	//level.activ iprintlnbold("Don't let the ^1Runner ^7past whilst staying in your area");
	wait 2;
	wait 0.05;
//AUTO 	iPrintlnBold(" ^7>>^13^7<<");
	wait 1;
//AUTO 	iPrintlnBold(" ^7>>^12^7<<");
	wait 1;
//AUTO 	iPrintlnBold(" ^7>>^11^7<<");
	wait 1.5;
//AUTO 	iPrintlnBold(" ^7>>^1B^7ulldog!^7<<");
	player freezeControls(0);
	level.activ freezeControls(0);
	while( isAlive( player ) && isDefined( player ) )
			wait 0.1;
...
//AUTO 	//player allowSprint(true);
	pts = 1;
//AUTO 	player iprintlnbold("^1You Win! ^7now switch roles.");
	wait 1;
	level.round1 = 0;
	player freezeControls(1);
	level.activ freezeControls(1);
...
//AUTO 	level.activ iprintlnbold("You Are The ^1Runner");
//AUTO 	player iprintlnbold("You Are The ^1Bulldog");
	wait 1;
	thread attacker_status2(player);
	thread runner_check(level.activ);
	player freezeControls(0);
//AUTO 	//level.activ iprintlnbold("^1Run ^7Past The ^1Bulldog ^7To The Other Side");
//AUTO 	//player iprintlnbold("Don't let the ^1Runner ^7past whilst staying in your area");
	wait 2;
	wait 0.05;
//AUTO 	iPrintlnBold(" ^7>>^13^7<<");
	wait 1;
...
//AUTO 	iPrintlnBold(" ^7>>^1B^7ulldog!^7<<");
	...
	trig1 waittill("trigger", player);
	level.bulldogOn = 0;
//AUTO 	iprintlnbold("^7The game came out a ^1Draw. ^7It'll now be a ^1Knife ^7fight.");
	player freezeControls(1);
	level.activ freezeControls(1);
//AUTO 	player giveWeapon("knife_mp");
//AUTO 	player switchtoweapon("knife_mp");
...
//AUTO 		player iprintlnbold("Why have you not gone yet?");
}
...
attacker_status(player)
{
	...
	if (level.round1 == 1)
	{
		...
		{
			trig2.touch = true;
//AUTO 			//level.activ setperk("sprintMultiplier 999");
//AUTO 			//level.activ allowSprint(false);
		}
		else
		{
			trig2.touch = false;
//AUTO 			//level.activ allowSprint(true);
		...
		{
//AUTO 			level.activ iPrintLnBold("^1You Cannot leave your area!");
...
//AUTO 			//player allowSprint(true);
		...
		if ( trig2.touch == false )
		{
//AUTO 			player iPrintLnBold("^1You Cannot leave your area!");
			player setOrigin(tp.origin);
		}
	}
	wait 0.1;
...
//AUTO 		level.activ takeallweapons();
//AUTO 		pro takeallweapons();
//AUTO 		pro giveweapon("deserteagle_mp");
//AUTO 		pro giveMaxAmmo();
//AUTO 		pro switchtoweapon("deserteagle_mp");
...
killstreak()
{
	if(!isdefined(level.activKills))
		...
		{
//AUTO 			level.activ iprintLnBold("^1You ^7Got A Life For Getting A ^13 ^7Killstreak");
		...
		{
//AUTO 			level.activ iprintLnBold("^1You ^7Got A Life For Getting A ^15 ^7Killstreak");
			//level.activ braxi\_mod::giveLife();
		}	
}
...
vipsongs()
{
	...
	for(;;)
	{
		...
		if(used == 3)
		{	
//AUTO 			player iprintlnbold("^1You can only change the song three times");
			for(;;)
			{
				wait 20;
			}
...
//AUTO 		case 9: AmbientPlay("song4");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Wiley ^1- ^7Bring Them All/Holy Grime");
			break;
		}
//AUTO 		case 10: AmbientPlay("song3");
		{
//AUTO 			iprintln(">^1Song^7<");
//AUTO 			iprintln("Yungen ^1- ^7You Don't Know Me Like That");
			break;
...
//AUTO 			player switchToWeapon("deserteagle_mp");
			player detachAll();
//AUTO 			player iprintlnbold("VIP features given.");
			player playsound("heyguys");
			player thread secret_secret();
			wait 0.5;
//AUTO 			player iPrintLn("^1Info ^7> ^1Server Speed: ^7[^1"+getDvar("g_speed")+"/"+getDvar("dr_jumpers_speed")+"^7]");
	}
}
...
secretxp()
{
	...
	trig waittill("trigger", player);
//AUTO 	iprintlnBold(player.name+" ^1Found the ^7XP ^1Secret^0!");
...
//AUTO 			player iprintlnbold("^5S^7orry, ^5VIP ^1Only^7.");
		else if(player.presses == 11)
//AUTO 			player iprintlnbold("Mate You aren't ^1VIP");
		else if(player.presses == 18)
//AUTO 			player iprintlnbold("^1FFS ^7You think i'm just gonna let ^1you ^7in if you ^1spam it?");
		else if(player.presses == 27)
		{
			player setOrigin(tp.origin);
//AUTO 			player iprintlnbold("^1No. ^7Every ^1F ^7is gonna ^1hurt ^7you now ;)");
		}
		else if(player.presses > 27)
			player FinishPlayerDamage(player, player, 20, 0, "MOD_FALLING", "jump_mp", player.origin, AnglesToForward((-90,0,0)), "none", 0);
	...
	else
		{
			...
			player.health = 100;
//AUTO 			player iprintlnbold("^1LOL ^7alright i'll let ^1you in.");
//AUTO 			wait 1;
			player setOrigin(tp.origin);
//AUTO 			wait 0.5;
			player playsound("heyguys");
...
secret_enter()
{
    ...
    {
        trig waittill ("trigger", player);
//AUTO 		player iPrintlnBold ("^1You have 5 tries!");
...
secretmain(which)
{
	...
	for(;;)
	{
		...
		if(which == 0)
		{
//AUTO 			player iprintlnbold("^1Shoot ^7the ^25 ^1Teddies ^7to get into the ^1Secret");
			level.quest = "Teddies";
			player thread easysecret();
		}
		else if(which == 1)
		{
//AUTO 			player iprintlnbold("^1Shoot ^7the ^25 ^1Radios ^7to get into the ^1Secret");
			level.quest = "Radios";
...
//AUTO 			//iPrintlnBold("^5> ^1Map ^7Creator ^1Mewen ^7has Joined^1!^5 <");
		}
...
specialmenu()
{
	...
	for(;;)
	{
		...
		{
//AUTO 			player iprintlnbold("^5> ^1VIP ^5Player^1! ^5<");
//AUTO 			player giveweapon("deserteagle_mp");
//AUTO 			player GiveMaxAmmo("deserteagle_mp");
...
//AUTO 					wait 1;
			...
			{
//AUTO 				player iPrintlnBold("Don't Recognise you m8");
				player playsound("heyguys");
			}
	}
}
