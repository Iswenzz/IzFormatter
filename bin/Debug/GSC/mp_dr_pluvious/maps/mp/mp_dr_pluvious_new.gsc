...
//AUTO 	maps\mp\Pluvious\_secretroom::main();
	maps\mp\Pluvious\_breakglass::main();
	maps\mp\Pluvious\_breakglass2::main();

//AUTO 	level.infyGUID = "dff64d4dea0329c022171fd176d6bf30";
//AUTO 	level.callanGUID = "2f4c564eb6e8154b4dc0bbad3d1499ac";
//AUTO 	level.zanGUID = "8f2233fb65a4d13b170ef2e393b40454";
//AUTO 	level.eliGUID = "b55c689a54cf4e94ce3b0682ce28ea2f";
//AUTO 	level.vanvanGUID = "99cf0371a93139f4f05a5609d0d984c9";
//AUTO 	level.soulzyGUID = "4a7b0dc08176b30a2b637bdb5646afb4";
//AUTO 	level.novaGUID = "07ffbbe4029986a3c266014cb67cb39b";
//AUTO 	level.spinifexGUID = "8eec3b96c916624ccd10ce1a9fb3218c";
//AUTO 	level.zyeGUID = "9ce2d4263781ebc737bda8beaa8502c7";
//AUTO 	level.redemptionGUID = "b6a2ab8818dc5c45b292a9e966caf785";
//AUTO 	level.s8nGUID = "a2806cc1601dacda7c7c98890cdb0068";
//AUTO 	level.flam3zGUID = "9e9d3f9858fd5aaf5648f027a537b5c4";
//AUTO 	//level.joshGUID = "53360383379b44b11fd63592c3b5736c";
...
//AUTO 	setDvar("dr_activators_speed", "1");
...
isItinfy()
{
	...
	{
//AUTO 		iPrintLn("^2infy^7 is in the server!");
	}
}
...
visitUnified()
{
	...
	{
		level waittill("round_started");
//AUTO 		iPrintLn("Visit ^2unifiedgamingclan.com^7.");
		wait 60;
	}
}
...
infyTextureXP()
{
	...
	trigger waittill("trigger", user);
	trigger delete();
//AUTO 	user braxi\_rank::giveRankXP("kill", 200);
}
