...
//AUTO 	iprintlnbold("portal 1 created");
...
{
	wait 0.1;
//AUTO 	player giveweapon("portalgun");
//AUTO 	//player switchtoweapon("portalgun");
//AUTO 	player givemaxammo("portalgun");
...
spawnsetup()
{
	...
	level common_scripts\utility::waittill_any("round_started","game started");
	//self disableWeapons();
//AUTO 	//self iprintlnbold("weapon disabled for intro");
//AUTO 	//ambientPlay("sp_a1_intro1_b1");
	//thread roomlink();
	thread light();
	//wait 5;
//AUTO 	//iprintlnbold("intro start");
	//thread b1();
}
...
ulp()
{
	...
	self.linker delete();
	self enableWeapons();
//AUTO 	self iprintlnbold("unlinked");
}
