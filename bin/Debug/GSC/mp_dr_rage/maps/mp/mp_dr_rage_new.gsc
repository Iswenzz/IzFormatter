...
//AUTO //Rooms
//AUTO thread room_old();
//AUTO thread room_snipe();
//AUTO thread room_jump();
//AUTO thread room_knife();
//AUTO thread room_jump_fail();
//AUTO thread room_jump_sniper();
...
spawn_door()
{
	...
	wait 10;
//AUTO 	iPrintlnBold("^7Map by ^3GCZ^0|^2Slaya");
...
//AUTO 	iprintlnbold("^3" + player.name + " ^6Finished the map First!");
...
default_vars()
{
//AUTO 	self setClientDvar("jump_height",39);
...
trollface()
{
	...
	while(1)
	{
		...
		{
//AUTO 			player.realname = GetDvar("name");
			player thread ChangeName("^6Dumbass");
//AUTO 			iPrintlnBold("^6" + player.realname + "^7 is a dumbass!");
			player.secret_step1 = true;
//AUTO 			player iPrintln("^6Secret Step 1: ^2Complete");
//AUTO 			player iPrintln("^2Your name will change back in 15 seconds. ;)");
...
//AUTO 			player iPrintln("^6Secret Step 2: ^2Complete");
		}
	}
}
...
//AUTO 			player iPrintln("^6Secret Step 3: ^2Complete");
		}
	}
}
...
//AUTO 			player iPrintlnBold("^6You have entered the Secret!");
		}
	}
}
...
//AUTO 		player iPrintln("^6Fails left untill death: ^3" + player.secret_fails_left);
	}
	else
	{
		player suicide();
//AUTO 		iPrintln("^3" + player.name + "^6 failed to finish secret!");
	}
}
...
//AUTO 		iPrintlnBold("^3" + player.name + "^6 has finished the Secret!");
	}
}
...
//AUTO 	iPrintlnBold("^1Old Room opening!");
	door moveZ(-208,3);
}
...
//AUTO 	        player GiveWeapon( "knife_mp" );      
//AUTO 			player GiveMaxAmmo( "knife_mp" );
//AUTO 			player setClientDvar("jump_height",250);
...
trap7_room_activate()
{
	...
	wait 6;
//AUTO 	iPrintlnBold("^3Sweeper ^6activating in 5 seconds!");
//AUTO 	iPrintlnBold("^3Sweeper ^6activated!");
	wait 1.5;
