...
//AUTO 	precacheItem( "ak47_mp" );
	...
	thread secret_end();
	thread jump_fail();
//AUTO 	thread knife_fail();
	thread snip_fail();
//AUTO 	thread end_tp_rooms();
	thread dorsser69();
//AUTO 	thread sniper_room_BATTLE();
//AUTO 	thread knife_room_BATTLE();
//AUTO 	thread deagle_room_BATTLE();
//AUTO 	thread jump_room_BATTLE();
	thread jump_unlock();
//AUTO 	thread jump_room_gun_jumper();
//AUTO 	thread jump_room_gun_acti();
	thread jump_wall();
//AUTO 	thread banana_move1();
//AUTO 	thread banana_move2();
//AUTO 	thread banana_move3();
//AUTO 	thread banana_move3_1();
//AUTO 	thread banana_move4();
//AUTO 	thread banana_move5();
//AUTO 	thread banana_move6();
//AUTO 	thread banana_move7();
//AUTO 	thread banana_move8();
//AUTO 	thread banana_move9();
//AUTO 	thread banana_move10();
//AUTO 	thread banana_move11();
//AUTO 	thread banana_move11_1();
//AUTO 	thread banana_move12();
	thread trap_01_1();
	thread trap_01_2();
	thread trap_02();
	thread trap_02_2();
	...
	start_button()
{
	...
	{
	wait 0.5;
//AUTO 	ambientPlay("samsara");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Samsara - Tungevaag & Raaban ^2]] ^1>>>");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Samsara - Tungevaag & Raaban ^2]] ^1>>>");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Samsara - Tungevaag & Raaban ^2]] ^1>>>");
	 button movez(-8,2);
	...
	{
	wait 0.5;
//AUTO 	ambientPlay("springfield");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Springfield - Martin Tungevaag & Italobrothers ^2]] ^1>>>");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Springfield - Martin Tungevaag & Italobrothers ^2]] ^1>>>");
//AUTO 	iprintln("<<< ^3Now playing ^2[[^5 Springfield - Martin Tungevaag & Italobrothers ^2]] ^1>>>");
	 button movez(-8,2);
	object1 rotateroll(-90, 4);
...
//AUTO 	iPrintlnBold (" ^5" + player.name + " ^2 is high!");
	}
	...
	secret_end()
{
	...
	player SetOrigin(end.origin);
        player SetPlayerAngles( end.angles );
//AUTO 	iPrintlnBold( " ^6" + player.name + " ^5Finished ^24^32^10" );
...
//AUTO 	 iPrintlnBold("^2"+self.name+" ^5Opened Final Door^1!");
	...
	sniper_room_BATTLE()
{
        ...
        while(1)
        {
                ...
                ambientStop("0");
                wait 0.05;
//AUTO                 ambientPlay("Followme");
 
                level.canPlaySound = false;
//AUTO  		iprintln("<<< ^3Now playing ^2[[^5 Follow me - Tritonal feat. Underdown^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Follow me - Tritonal feat. Underdown^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Follow me - Tritonal feat. Underdown^2]] ^1>>>");
	...
	knife_room_BATTLE()
{
		...
		level.activ thread knife_fail();
                ...
                ambientStop("0");
                wait 0.05 ;
//AUTO                 ambientPlay("rage");
 
                level.canPlaySound = false;
 
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Rage Valley - Knife Party^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Rage Valley - Knife Party^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Rage Valley - Knife Party^2]] ^1>>>");
...
//AUTO 		iPrintlnBold( " ^5Activator ^5is AFK, Path is now enabled in knife room" );
	}
}
	...
	deagle_room_BATTLE()
{
        ...
        while(1)
        {
                ...
                ambientStop("0");
                wait 0.05;
//AUTO                 ambientPlay("desert");
 
                level.canPlaySound = false;
 
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Desert Eagle - Ratatat^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Desert Eagle - Ratatat^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5 Desert Eagle - Ratatat^2]] ^1>>>");
...
//AUTO                 iPrintlnBold( " ^6" + player.name + " ^5Entered Deagle room." );
                wait 0.05;
	...
	jump_room_BATTLE()
{
		...
		level.activ thread jump_fail();
                ...
                ambientStop("0");
                wait 0.05 ;
//AUTO                 ambientPlay("bance");
 
                level.canPlaySound = false;
 
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Bounce - System Of a down^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Bounce - System Of a down^2]] ^1>>>");
//AUTO                 iprintln("<<< ^3Now playing ^2[[^5Bounce - System Of a down^2]] ^1>>>");
	...
	jump_unlock()
{
	...
	trigger waittill ("trigger" , player );
//AUTO 	iPrintlnBold ("^3" + player.name +" ^1 Unlocked something...?");
	wall delete();
}
	...
	jump_wall()
{
	...
	banana_move1()
{
//AUTO 	trigger = getEnt ("banana_move1","targetname");
//AUTO 	object = getEnt ("banana_move1_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object.origin, 3);
//AUTO 	banana waittill ("movedone");
}

	banana_move2()
{
//AUTO 	trigger = getEnt ("banana_move2","targetname");
//AUTO 	object = getEnt ("banana_move2_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object.origin, 3);
//AUTO 	banana rotateyaw (-90,3);
//AUTO 	banana waittill ("movedone");
}

	banana_move3()
{
//AUTO 	trigger = getEnt ("banana_move3","targetname");
//AUTO 	object1 = getEnt ("banana_move3_1_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object1.origin, 1.5);
//AUTO 	banana waittill ("movedone");
}

	banana_move3_1()
{
//AUTO 	trigger = getEnt ("banana_move3_1","targetname");
//AUTO 	object1 = getEnt ("banana_move4_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (45, 1.5);
//AUTO 	banana waittill ("rotatedone");
//AUTO 	banana moveto (object1.origin, 2);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (45, 1.5);
//AUTO 	banana waittill ("rotatedone");
}
	...
	banana_move4()
{
//AUTO 	trigger = getEnt ("banana_move4","targetname");
//AUTO 	object = getEnt ("banana_move5_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object.origin, 1.5);
//AUTO 	banana waittill ("movedone");
}

	banana_move5()
{
//AUTO 	trigger = getEnt ("banana_move5","targetname");
//AUTO 	object1 = getEnt ("banana_move6_go","targetname");
//AUTO 	object2 = getEnt ("banana_move6_1_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (45,1.5);
//AUTO 	banana moveto (object1.origin, 1.5);
...
//AUTO 	banana rotateyaw (-45,1.5);
//AUTO 	banana waittill ("rotatedone");
//AUTO 	banana moveto (object2.origin, 4);
//AUTO 	banana rotateyaw (-90,3);
//AUTO 	banana waittill ("rotatedone");
}
	...
	banana_move6()
{
//AUTO 	trigger = getEnt ("banana_move6","targetname");
//AUTO 	object1 = getEnt ("banana_move7_go","targetname");
//AUTO 	object2 = getEnt ("banana_move7_1_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (45,1.5);
//AUTO 	banana moveto (object1.origin, 1.5);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (45,1.5);
//AUTO 	banana moveto (object2.origin, 1.5);
//AUTO 	banana waittill ("movedone");
}

	banana_move7()
{
//AUTO 	trigger = getEnt ("banana_move7","targetname");
//AUTO 	object = getEnt ("banana_move8_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object.origin, 3);
//AUTO 	banana waittill ("movedone");
	...
	banana_move8()
{
//AUTO 	trigger = getEnt ("banana_move8","targetname");
//AUTO 	object = getEnt ("banana_move9_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object.origin, 1.5);
//AUTO 	banana waittill ("movedone");
	...
	banana_move9()
{
//AUTO 	trigger = getEnt ("banana_move9","targetname");
//AUTO 	object = getEnt ("banana_move10_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (-45,3);
//AUTO 	banana moveto (object.origin, 2);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (90, 1.5);
//AUTO 	banana waittill ("rotatedone");
}

	banana_move10()
{
//AUTO 	trigger = getEnt ("banana_move10","targetname");
//AUTO 	object = getEnt ("banana_move11_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (45, 1.5);
//AUTO 	banana moveto (object.origin, 3);
...
//AUTO 	banana waittill ("rotatedone");
	...
	banana_move11()
{
//AUTO 	trigger = getEnt ("banana_move11","targetname");
//AUTO 	object = getEnt ("banana_move11_1_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (90,4);
//AUTO 	banana moveto (object.origin, 4);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (-45, 1);
//AUTO 	banana waittill ("rotatedone");
}

	banana_move11_1()
{
//AUTO 	trigger = getEnt ("banana_move11_1","targetname");
//AUTO 	object = getEnt ("banana_move12_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana rotateyaw (90,2.5);
//AUTO 	banana waittill ("rotatedone");
//AUTO 	banana moveto (object.origin, 2.5);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (-45,1);
//AUTO 	banana waittill ("rotatedone");
}
	...
	banana_move12()
{
//AUTO 	trigger = getEnt ("banana_move12","targetname");
//AUTO 	object1 = getEnt ("banana_move13_go","targetname");
//AUTO 	object2 = getEnt ("banana_move13_1_go","targetname");
//AUTO 	object3 = getEnt ("banana_move13_2_go","targetname");
//AUTO 	banana = getEnt ("banana","targetname");
	trigger waittill ("trigger", player );
//AUTO 	banana moveto (object1.origin, 1.5);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana moveto (object2.origin, 3);
//AUTO 	banana waittill ("movedone");
//AUTO 	banana rotateyaw (200, 3);
//AUTO 	banana moveto (object3.origin, 3);
//AUTO 	banana waittill ("movedone");
}
