...
//AUTO 	PrecacheItem( "slaya_deagle" );
...
GiveSlayaHisSmexyDeagle()
{
	...
	for(i=0;i<players.size;i++)
	{
		...
		{
//AUTO 			players[i] GiveWeapon( "slaya_deagle" );
//AUTO 			players[i] GiveMaxAmmo( "slaya_deagle" );
			wait .05;
//AUTO 			players[i] SwitchToWeapon( "slaya_deagle" );
//AUTO 			players[i] iPrintlnBold( "^3This map loves you ^7" + players[i].name );
		}
	}
}
...
//AUTO 	iPrintlnBold(player.name + " ^3Finished the map First!");
...
SpawnShizzle()
{
	...
	level waittill( "round_started" );
//AUTO 	iPrintlnBold( "Map by Raid|^9Slaya" );

	wait 5;
//AUTO 	iPrintlnBold("^9Slaya Time!");
	door MoveZ(464, 5);
...
//AUTO 	iPrintlnBold( player.name + "^3 has opened Old!" );
...
room_jump_sniper()
{
	...
	{
		trig waittill("trigger", player);
//AUTO 		player GiveWeapon("slaya_dsr50");
//AUTO 		player GiveMaxAmmo("slaya_dsr50");
		wait .05;
...
//AUTO 	iPrintlnBold( player.name + "^3 got a Smexy Deagle!" );

//AUTO 	player GiveWeapon( "slaya_deagle" );
//AUTO 	player GiveMaxAmmo( "slaya_deagle" );
	wait .05;
//AUTO 	player SwitchToWeapon( "slaya_deagle" );
}
...
SecretCheckEnter()
{
	...
	{
//AUTO 		self iPrintlnBold( "^9Fgt, hands off!" );
//AUTO 		self iPrintln( "^3Secret Steps Complete: ^91/3" );
	}
	else if( self.secret_steps_complete == 2 )
	{
//AUTO 		self iPrintlnBold( "^9I told you, HANDS OFF!" );
//AUTO 		self iPrintln( "^3Secret Steps Complete: ^92/3" );
	}
	else if( self.secret_steps_complete == 3 )
	{
//AUTO 		self iPrintlnBold( "^9Don't wanna listen fgt?! UNDERGO MY WRATH!!!" );
//AUTO 		self iPrintln( "^3Secret Steps Complete: ^93/3" );
...
SecretTimer()
{
	...
	if( !self.secret_finished )
	{
		...
		self Suicide();
//AUTO 		self iPrintlnBold( "^3Nub, you didn't finish secret in time..." );
	}
}
...
//AUTO 		iPrintlnBold( player.name + "^3 has finished the ^9Secret^3!" );
