...
self playSound("enterpaint");

	{
		if(i == 0)
		{
//AUTO 			self playLocalSound("song1");
		}
		else if(i == 1)
		{
//AUTO 			self playLocalSound("song2");
		}
		else if(i == 2)
		{
//AUTO 			self playLocalSound("song5");
		}
		else if(i == 3)
		{
//AUTO 			self playLocalSound("song6");
		}
	}
}
...
i = randomintrange(0, 2);

	{
		...
		if(i == 0)
		{
//AUTO 			activator playLocalSound("song1");
		}
		else if(i == 1)
		{
//AUTO 			activator playLocalSound("song2");
		}
	}
}
...
//AUTO 	player playLocalSound("song3");
	}
}
...
//AUTO 	player playLocalSound("song4");
	}
}
...
//AUTO 	players playLocalSound("song4");
	}
}
...
i = randomintrange(0, 2);
	...
	ambienttrig3 waittill("trigger",player);
		...
		if(i == 0)
		{
//AUTO 			player playLocalSound("song1");
		}
		else if(i == 1)
		{
//AUTO 			player playLocalSound("song2");
		}
	}
}
...
//AUTO 	player braxi\_rank::giveRankXP("", 300);
//AUTO 	iPrintLnBold( player.name + " ^1Found the ^9Dark Star");
	player playSound("finish3");
	darkstar9t hide();
	wait 2;
	player suicide();
//AUTO 	iPrintLn( "^9Dark Star ^1killed " + player.name );
	}
}
...
//AUTO 	iprintlnbold( player.name + " ^2Entered the ^1HARD ^3Secret !!" );
...
//AUTO 	player braxi\_rank::giveRankXp("", 600);
//AUTO 	iprintlnbold( player.name + " ^3Finished ^1HARD ^7Secret ^21 !!!!" );
...
//AUTO 	iprintlnbold( player.name + " ^3Finished ^1HARD ^7Secret ^12 !!!!" );
...
//AUTO 	self iPrintlnBold( "You've finished in ^6" + time1 );
...
//AUTO 	self iPrintLnBold("^5You ^7have^6 60 ^7seconds to ^5finish ^7!");
...
//AUTO 	iPrintlnBold( self.name + " finished ^1HARD ^7secret slide in ^1" + time2 );
...
hardSecretTimer()
{
	...
	wait 0.05;
	self playSound("warp1");
//AUTO 	self iPrintLnBold("^1You have^8 30 ^7seconds to ^1finish ^7!");
...
//AUTO 		user playLocalSound("song3");
	}
}
...
//AUTO 	player iprintlnbold("^3You ^2Won ^3100 XP^2!!");
	box moveZ(10, 0.5);
...
//AUTO 	iPrintLnBold("^3Start door opened :]");
...
//AUTO 	player braxi\_rank::giveRankXP("", 100);
//AUTO 	player iPrintLnBold("^2You ^7won ^3100 XP ^7!");
...
//AUTO 	player iPrintLnBold("^2You ^7won ^3150 XP ^7!");
	player playSound("finish3");
	star4 hide();
	}
}
...
//AUTO 	player iPrintLnBold("^2You ^7won ^315 XP ^7!");
	wait 0.2;
	}
}
...
//AUTO 		iPrintLn("^3Map Made By: ^5SuX ^7Lolz :]");
		wait 4;
//AUTO 		iPrintLn("^5I accept any donation @ Paypal : ^7suxlolz@outlook.fr");
		wait 8;
...
//AUTO 		user GiveWeapon( "m40a3_mp" );
//AUTO 		user GiveMaxAmmo( "m40a3_mp" );
//AUTO 		iPrintLnBold ("^3VIP ^7is ^2Connected");
		wait 3;
		}
			else
			{
...
{ 
self common_scripts\utility::waittill_any("death","disconnect");
//AUTO iPrintlnBold("^2"+self.name+" ^7is ^2dead"); 
//AUTO iPrintlnBold("^3Selection ^7Room ^3is ^3now ^7open^3!!"); 
}
...
//AUTO 	activator switchtoweapon("remington700_mp");
	player freezeControls(true);
//AUTO 	player takeallweapons();
//AUTO 	wait 0.2;
}
