...
//AUTO 	iprintlnbold ("^3=>^1" + player.name + "^3<= ^2has picked the key");
...
//AUTO 	iprintlnbold ("^3=>^1" + player.name + "^3<= ^2finished Super Mario map 1st.");
	wait 0.5;
//AUTO 	iprintlnbold ("^3=>^1" + player.name + "^3<= ^2opened the FINAL door!");
