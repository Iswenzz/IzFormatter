...
main_fall()
{
	...
	trig_broken delete();
//AUTO 	iprintlnbold("^5--->^7Map Creator ^1sixzoRR- ^7xFire:^5dinac777^5<---");
	wait 0.2;
//AUTO 	iprintlnbold("^5--->^7Special Thanks ^1#FNRP#Lolz^5<---");
	wait 5;
//AUTO 	AmbientPlay( "ambient2" );
//AUTO 	iprintlnbold("^13");
	wait 2;
//AUTO 	iprintlnbold("^12");
	wait 2;
...
secretdoor()
{
	...
	trig delete();
	door delete();
//AUTO 	AmbientPlay( "ambient10" );
//AUTO 	iprintlnbold("^1Secret is open");
}
...
finishdoor()
{
	...
	trig delete();
	door movez(290,5);
//AUTO 	iprintlnbold("^5Finish Door is Open");
	wait 4;
	door delete();;
}
...
while( 1 )
{
//AUTO iPrintLn("^7Map By:^5'sixzoRR- , ^7xFire:^1dinac777");
wait(10);
//AUTO iPrintLn("^1MP_DR_SPACETRIP");
wait(10);
//AUTO iPrintLn("^7Special Thanks ^5#FNRP#Lolz,^1MadLion,^5Matty,^1VC'ERIK");
}
}
...
//AUTO     iPrintlnBold( " ^1" + player.name + "^7 Has Chosen ^1Sniper Room^5!!" );  
...
//AUTO             level.activ iPrintlnBold( "^5Fight!" );
...
//AUTO     iPrintlnBold( " ^1" + player.name + " ^7Has Chosen ^1Knife Room^5!!" ); 	
    level.finalJumper FreezeControls(1);
    level.activ FreezeControls(1);
    wait 3;
//AUTO 	        player iPrintlnBold( "^13" );
...
//AUTO     iPrintlnBold( " ^1" + player.name + "^7 Has Chosen ^1Jump Room^5!!" );  
    level.finalJumper FreezeControls(1);
    level.activ FreezeControls(1);
    wait 3;
//AUTO             player iPrintlnBold( "^13" );
...
//AUTO 	iPrintlnBold( " ^1" + player.name + "^7 Has Chosen ^1Deagle Room^5!!" ); 									
    level.finalJumper FreezeControls(1);
    level.activ FreezeControls(1);
    wait 3;
//AUTO 	        player iPrintlnBold( "^13" );
