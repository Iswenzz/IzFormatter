...
endroom_template(trigger, jumper_origin, acti_origin, weapon, weapon2, weapon_room, song_name)
{
    ...
    while(1)
    {
		...
		if(song_name == "dumdeedum"){
			iPrintLn("^6Now Playing: ^5Keys N Krates - ^1Dum Dee Dum (JiKay Remix)");
		}
		
		if(song_name == "heights"){
			iPrintLn("^6Now Playing: ^5Vadyr - ^1Heights");
		}
		
		if(song_name == "amilli"){
			iPrintLn("^6Now Playing: ^5Lil Wayne - ^1A Milli (K Theory)");
		}
...
ambient(){
	...
	if(possibility == 0){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Lenka - Blue Skies(REVOKE REMIX)");
				wait 25;
			}
		}
	}
	...
	if(possibility == 1){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Jetta - I'd Love to Change the World (Matstubs Remix)");
				wait 25;
			}
		}		
	}
	...
	if(possibility == 2){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6The Chainsmokers - Dont Let Me Down (Illenium Remix)");
				wait 25;
			}
		}		
	}
	...
	if(possibility == 3){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Twenty One Pilots - Stressed Out (Tomsize Remix)");
				wait 25;
			}
		}		
	}
	...
	if(possibility == 4){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Lukas Graham - 7 Years (T-Mass Remix) [feat. Toby Romeo]");
				wait 25;
			}
		}				
	}
	...
	if(possibility == 5){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6G-Eazy & Bebe Rexha - Me, Myself & I (No Sleep Remix)");
				wait 25;
			}
		}			
	}
	...
	if(possibility == 6){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Black Coast - TRNDSTTR (Lucian Remix)");
				wait 25;
			}
		}
	}
	...
	if(possibility == 7){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Jetta - Take It Easy (Matstubs Remix)");
				wait 25;
			}
		}			
	}
	...
	if(possibility == 8){
		...
		while(1){
			if(level.isFinished == false){
				iprintln("^2Now playing: ^6Diplo - Revolution (SEAN&BOBO REMIX)");
				wait 25;
			}			
		}		
	}			
...
startround(){
	level waittill( "round_started" );  
	wait 1;
	iprintlnbold("^1Welcome to ^3Stormy Ascent");
	wait 2;
	iprintlnbold("^2Map made by: ^5#FNRP#^6Gabb");
	wait 3;
