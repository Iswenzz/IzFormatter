...
//AUTO 		wait 5;
//AUTO 		player iPrintlnBold( "CongratZ!" );
...
{
 c=c+1;
//AUTO self braxi\_rank::giveRankXp( "headshot" );
 wait 0.1; 
 } 
} 
...
trig waittill( "trigger", player );
//AUTO player braxi\_rank::giveRankXp( "headshot" );
trig delete();
...
trig delete();
player braxi\_mod::givelife();
//AUTO player iprintlnbold("^1You got a free life!");
noti = SpawnStruct();
...
//AUTO 	level.activ iPrintlnBold( "^1SHH!,^7Someone is coming" );
//AUTO 	level.activ iPrintlnBold( "^1Take this ^7:D" );
	wait 1;
...
//AUTO 	player iPrintlnBold( "^1MURDAAAAARRR ^7for 15s" );
	wait 15;
	player SetPlayerAngles( p2.angles );
	player setOrigin( p2.origin );
//AUTO 	player iPrintlnBold( "^7Had Fun ^1cunt?!" );
