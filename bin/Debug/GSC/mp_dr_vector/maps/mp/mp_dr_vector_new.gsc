...
//AUTO 	//ambientPlay("ambient_backlot_ext");
//AUTO 	ambientPlay("sail");
	//fx
...
burn()
{
    ...
    self thread firefix();
//AUTO 	self SetMoveSpeedScale( 1.5 );
...
firefix2()
{
	...
	wait 2;
//AUTO 	iprintln(self.name + " ^1Burned.");
}
...
//AUTO 	iprintln(self.name + " ^3burned.");
	self.fire =false;
}
...
//AUTO 	iprintlnbold ("^2"+player.name+" ^7Choose Jump Room");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	level.knife delete();
	level.sniper delete();
...
//AUTO 	iprintlnbold ("^2"+player.name+" ^7Choose Knife Room");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	level.jump delete();
	level.sniper delete();
	level.classic delete();
...
//AUTO 	iprintlnbold ("^2"+player.name+" ^7Choose Sniper Room");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	level.knife delete();
	level.jump delete();
	level.classic delete();
...
//AUTO 	iprintlnbold ("^2"+player.name+" ^7Choose the Old Way");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	level.sniper delete();
	level.knife delete();
	level.jump delete();
...
//AUTO 	iprintlnbold ("^2"+player.name+" ^7Choose Surf Room");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	level.knife delete();
	level.jump delete();
	level.sniper delete();
...
//AUTO self giveweapon( "winchester1200_mp");
//AUTO     self GiveMaxAmmo("winchester1200_mp");	
	wait 0.5;
//AUTO 	self switchToWeapon( "winchester1200_mp" );
//AUTO 	self SetMoveSpeedScale( 3.5 );
}	
...
//AUTO 	player SetMoveSpeedScale( 7 );
//AUTO 	wait 0.5;
	}
}	
...
//AUTO 	wait 1;
	player freezeControls( false);
//AUTO 	wait 0.5;
//AUTO 	iprintln(player.name + " ^1Finished Secret!");
//AUTO 	player braxi\_rank::giveRankXp( "trap_activation" );
	}
}
