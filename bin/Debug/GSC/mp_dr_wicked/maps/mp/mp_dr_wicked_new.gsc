...
//AUTO 		player iprintlnbold ("You have entered the secret room, Enjoy^1!");
...
{
		tele waittill ("trigger", player);
//AUTO 		player iprintlnbold ("You have been teleported back!");
		player SetOrigin(target.origin);
		player SetPlayerAngles( target.angles );
}
}
...
trig waittill ("trigger", user);
//AUTO iPrintlnBold( " ^1" + user.name + " ^7 Has Reached The End!" ); 
trig delete();
...
wait 0.05;
//AUTO acti SwitchToWeapon( "tomahawk_mp" );
wait 1;
...
//AUTO 			user GiveWeapon( "tomahawk_mp" );
			wait 0.05;
//AUTO 			user SwitchToWeapon( "tomahawk_mp" );
			wait 1;
}
}
}
